...
- **Apex status:** Ranking rows support `accepted_in_kb_base` scaffold guidance only.
...
- **Apex constraint:** Use this ledger as evidence for KB-base guidance only; do not treat it as global promotion approval.
