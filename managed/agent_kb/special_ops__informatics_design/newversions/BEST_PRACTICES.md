...
- **Source repo:** `leela-spec/MasterOfArts`
- **Target repo:** `leela-spec/MasterOfArts`
- **Target branch:** `main`
- **Target agent:** `special_ops__informatics_design`
- **Promptflow:** `OpenClaw/07_finalopenclawsystem/managed/agent_kb/special_ops__informatics_design/PROMPTFLOW_KB_BASE_BUILD.md`
