...
- **Trap:** In Apex AI OS, `accepted_in_kb_base` must not be read as runtime truth, config authority, or promotion approval.
...
- **Check:** Does any Apex-facing claim require governed promotion before use as runtime truth?
