...
- **Accepted scope:** included in the Apex KB base as current failure-pattern guidance.
- **Promotion boundary:** `strong_candidate` entries are reusable KB guidance, not direct runtime law.
