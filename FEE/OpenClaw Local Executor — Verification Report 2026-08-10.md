...
| Guard deployment | PENDING FINAL SOURCE REINSTALL | Protected identity `7db272b308118b4a1e3880907c21e47468cf98bd940f1b3c25eec2396ee28aa6` is installed at `C:\ProgramData\ApexExecutor\guards\guards-v1-7db272b308118b4a` with exact protected ACLs, matching manifest hashes, and exact equality to checkpoint `36908cee`. The first protected test correctly exposed that global exact-count validator discovery conflicted with immutable historical versions. The reviewed fix binds a protected dispatcher to its co-located manifest and validator; one successor installation is required before this gate returns to PASS. |
