...
- **Promptflow:** `OpenClaw/07_finalopenclawsystem/managed/agent_kb/special_ops__knowledge_bank/appendices/PROMPTFLOW_SPECIAL_OPS_KNOWLEDGE_BANK_KB_UPDATE_CORRECTED.md`
...
- **Legacy file:** `OpenClaw/07_finalopenclawsystem/managed/agent_kb/special_ops__knowledge_bank/PROMPTFLOW_KB_BASE_BUILD.md`
- **Status:** historical_context_only
- **Allowed use:** identify old target paths only when needed for conflict detection.
- **Forbidden use:** basis, generation sequence, execution method, or current authority.
- **Stop rule:** stop if a legacy promptflow conflicts with the corrected promptflow and the operator has not dispositioned the conflict.

## Source authority stack

|priority|source_path|source_role|read_status|use_in_this_build|
|---|---|---|---|---|
|0|`OpenClaw/07_finalopenclawsystem/managed/agent_kb/special_ops__knowledge_bank/appendices/PROMPTFLOW_SPECIAL_OPS_KNOWLEDGE_BANK_KB_UPDATE_CORRECTED.md`|corrected promptflow authority|read|defines current direct-main, no-branch, Codex-git-apply-only update flow|
...
## Corrected update consequence

|update_id|source|consequence|status|
|---|---|---|---|
|KB-UPD-001|corrected promptflow + `KBFuture.md`|add promotion trace appendix|approved_for_patch_pack|
|KB-UPD-002|corrected promptflow + `KBFuture.md`|add QA and next research appendix|approved_for_patch_pack|
|KB-UPD-003|corrected promptflow + `KBFuture.md`|add source notes appendix|approved_for_patch_pack|
|KB-UPD-004|corrected promptflow + `KBFuture.md`|add database schema appendix|approved_for_patch_pack|
|KB-UPD-005|corrected promptflow + `KBFuture.md`|add examples appendix|approved_for_patch_pack|
|KB-UPD-006|corrected promptflow|update templates for new database surfaces and proof reporting|approved_for_patch_pack|
|KB-UPD-007|corrected promptflow|update learning queue for deferred follow-ups|approved_for_patch_pack|
|KB-UPD-008|scaffold drift check|correct `ESSENCE.md` source basis|approved_for_patch_pack|
|KB-UPD-009|appendix drift check|correct source manifest execution lock|approved_for_patch_pack|
|KB-UPD-010|audit and corrected promptflow|record connector replacement and legacy-basis failure patterns|approved_for_patch_pack|
