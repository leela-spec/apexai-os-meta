...
URL Source: https://hermes-agent.nousresearch.com/docs/getting-started/quickstart
...
[Video 3](https://www.youtube.com/watch?v=R3YOGfTBcQg)
...
`pip install hermes-agenthermes postinstall     # optional: installs Node.js, browser, ripgrep, ffmpeg + runs setup`
