...
URL Source: https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#prerequisites "Direct link to Prerequisites")
...
## Quick Start (Any Nix User)[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#quick-start-any-nix-user "Direct link to Quick Start (Any Nix User)")
...
## NixOS Module[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#nixos-module "Direct link to NixOS Module")
...
### Add the Flake Input[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#add-the-flake-input "Direct link to Add the Flake Input")
...
### Minimal Configuration[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#minimal-configuration "Direct link to Minimal Configuration")
...
### Container-aware CLI[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container-aware-cli "Direct link to Container-aware CLI")
...
### Verify It Works[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#verify-it-works "Direct link to Verify It Works")
...
### Choosing a Deployment Mode[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#choosing-a-deployment-mode "Direct link to Choosing a Deployment Mode")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#configuration "Direct link to Configuration")

### Declarative Settings[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#declarative-settings "Direct link to Declarative Settings")
...
### Escape Hatch: Bring Your Own Config[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#escape-hatch-bring-your-own-config "Direct link to Escape Hatch: Bring Your Own Config")
...
### Customization Cheatsheet[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#customization-cheatsheet "Direct link to Customization Cheatsheet")
...
| Add MCP tool servers | `mcpServers.<name>` | See [MCP Servers](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#mcp-servers) |
...
## Secrets Management[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#secrets-management "Direct link to Secrets Management")
...
### sops-nix[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#sops-nix "Direct link to sops-nix")
...
### agenix[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#agenix "Direct link to agenix")
...
### OAuth / Auth Seeding[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#oauth--auth-seeding "Direct link to OAuth / Auth Seeding")
...
## Documents[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#documents "Direct link to Documents")
...
## MCP Servers[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#mcp-servers "Direct link to MCP Servers")
...
### Stdio Transport (Local Servers)[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#stdio-transport-local-servers "Direct link to Stdio Transport (Local Servers)")
...
### HTTP Transport (Remote Servers)[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#http-transport-remote-servers "Direct link to HTTP Transport (Remote Servers)")
...
### HTTP Transport with OAuth[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#http-transport-with-oauth "Direct link to HTTP Transport with OAuth")
...
### Sampling (Server-Initiated LLM Requests)[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#sampling-server-initiated-llm-requests "Direct link to Sampling (Server-Initiated LLM Requests)")
...
## Managed Mode[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#managed-mode "Direct link to Managed Mode")
...
## Container Architecture[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container-architecture "Direct link to Container Architecture")
...
### What Persists Across What[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#what-persists-across-what "Direct link to What Persists Across What")
...
### GC Root Protection[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#gc-root-protection "Direct link to GC Root Protection")
...
## Plugins[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#plugins "Direct link to Plugins")
...
Or use the pre-built `#messaging` or `#full` flake packages instead of per-extra configuration (see [Quick Start](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#quick-start-any-nix-user)).
...
### Combining Both[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#combining-both "Direct link to Combining Both")
...
### Using the Overlay[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#using-the-overlay "Direct link to Using the Overlay")
...
### Plugin Configuration[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#plugin-configuration "Direct link to Plugin Configuration")
...
## Development[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#development "Direct link to Development")

### Dev Shell[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#dev-shell "Direct link to Dev Shell")
...
### direnv (Recommended)[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#direnv-recommended "Direct link to direnv (Recommended)")

The included `.envrc` activates the dev shell automatically:

`cd hermes-agentdirenv allow    # one-time# Subsequent entries are near-instant (stamp file skips dep install)`

### Flake Checks[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#flake-checks "Direct link to Flake Checks")
...
## Options Reference[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#options-reference "Direct link to Options Reference")

### Core[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#core "Direct link to Core")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#configuration-1 "Direct link to Configuration")
...
### Secrets & Environment[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#secrets--environment "Direct link to Secrets & Environment")
...
### Documents[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#documents-1 "Direct link to Documents")
...
### MCP Servers[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#mcp-servers-1 "Direct link to MCP Servers")
...
### Service Behavior[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#service-behavior "Direct link to Service Behavior")
...
### Container[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container "Direct link to Container")
...
## Directory Layout[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#directory-layout "Direct link to Directory Layout")

### Native Mode[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#native-mode "Direct link to Native Mode")
...
### Container Mode[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container-mode "Direct link to Container Mode")
...
## Updating[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#updating "Direct link to Updating")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#troubleshooting "Direct link to Troubleshooting")

Podman users

All `docker` commands below work the same with `podman`. Substitute accordingly if you set `container.backend = "podman"`.

### Service Logs[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#service-logs "Direct link to Service Logs")
...
### Container Inspection[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container-inspection "Direct link to Container Inspection")
...
### Force Container Recreation[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#force-container-recreation "Direct link to Force Container Recreation")
...
### Verify Secrets Are Loaded[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#verify-secrets-are-loaded "Direct link to Verify Secrets Are Loaded")
...
### GC Root Verification[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#gc-root-verification "Direct link to GC Root Verification")

`nix-store --query --roots $(docker exec hermes-agent readlink /data/current-package)`

### Common Issues[​](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#common-issues "Direct link to Common Issues")
...
| `no container with name or ID "hermes-agent"` (Podman) | Podman rootful container not visible to regular user | Add passwordless sudo for podman (see [Container Mode](https://hermes-agent.nousresearch.com/docs/getting-started/nix-setup#container-mode) section) |
