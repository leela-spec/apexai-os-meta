...
URL Source: https://hermes-agent.nousresearch.com/docs/reference/cli-commands
...
## Global entrypoint[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#global-entrypoint "Direct link to Global entrypoint")

`hermes [global-options] <command> [subcommand/options]`

### Global options[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#global-options "Direct link to Global options")
...
| `--tui` | Launch the [TUI](https://hermes-agent.nousresearch.com/docs/user-guide/tui) instead of the classic CLI. Equivalent to `HERMES_TUI=1`. |
| `--dev` | With `--tui`: run the TypeScript sources directly via `tsx` instead of the prebuilt bundle (for TUI contributors). |

## Top-level commands[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#top-level-commands "Direct link to Top-level commands")
...
| `hermes bundles` | Group several skills under a single `/<name>` slash command. See [Skill Bundles](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills#skill-bundles). |
...
## `hermes chat`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-chat "Direct link to hermes-chat")
...
### `hermes -z <prompt>` — scripted one-shot[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes--z-prompt--scripted-one-shot "Direct link to hermes--z-prompt--scripted-one-shot")
...
## `hermes model`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-model "Direct link to hermes-model")
...
### `/model` slash command (mid-session)[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#model-slash-command-mid-session "Direct link to model-slash-command-mid-session")
...
## `hermes gateway`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-gateway "Direct link to hermes-gateway")
...
## `hermes lsp`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-lsp "Direct link to hermes-lsp")
...
## `hermes setup`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-setup "Direct link to hermes-setup")
...
## `hermes portal`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-portal "Direct link to hermes-portal")
...
## `hermes whatsapp`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-whatsapp "Direct link to hermes-whatsapp")

`hermes whatsapp`

Runs the WhatsApp pairing/setup flow, including mode selection and QR-code pairing.

## `hermes slack`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-slack "Direct link to hermes-slack")
...
## `hermes send`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-send "Direct link to hermes-send")
...
## `hermes secrets`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-secrets "Direct link to hermes-secrets")
...
## `hermes migrate`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-migrate "Direct link to hermes-migrate")
...
## `hermes proxy`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-proxy "Direct link to hermes-proxy")
...
## `hermes security`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-security "Direct link to hermes-security")
...
## `hermes login` / `hermes logout`_(Deprecated)_[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-login--hermes-logout-deprecated "Direct link to hermes-login--hermes-logout-deprecated")
...
## `hermes auth`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-auth "Direct link to hermes-auth")
...
## `hermes status`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-status "Direct link to hermes-status")
...
## `hermes cron`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-cron "Direct link to hermes-cron")
...
## `hermes kanban`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-kanban "Direct link to hermes-kanban")
...
## `hermes webhook`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-webhook "Direct link to hermes-webhook")
...
### `hermes webhook subscribe`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-webhook-subscribe "Direct link to hermes-webhook-subscribe")
...
## `hermes doctor`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-doctor "Direct link to hermes-doctor")
...
## `hermes dump`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-dump "Direct link to hermes-dump")
...
### What it includes[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#what-it-includes "Direct link to What it includes")
...
### Example output[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#example-output "Direct link to Example output")
...
### When to use[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#when-to-use "Direct link to When to use")
...
## `hermes debug`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-debug "Direct link to hermes-debug")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples "Direct link to Examples")
...
## `hermes backup`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-backup "Direct link to hermes-backup")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples-1 "Direct link to Examples")
...
## `hermes checkpoints`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-checkpoints "Direct link to hermes-checkpoints")
...
### Options[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#options "Direct link to Options")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples-2 "Direct link to Examples")
...
## `hermes import`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-import "Direct link to hermes-import")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples-3 "Direct link to Examples")
...
## `hermes logs`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-logs "Direct link to hermes-logs")

`hermes logs [log_name] [options]`

View, tail, and filter Hermes log files. All logs are stored in `~/.hermes/logs/` (or `<profile>/logs/` for non-default profiles).

### Log files[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#log-files "Direct link to Log files")
...
### Options[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#options-1 "Direct link to Options")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples-4 "Direct link to Examples")
...
### Filtering[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#filtering "Direct link to Filtering")
...
### Log rotation[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#log-rotation "Direct link to Log rotation")
...
## `hermes config`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-config "Direct link to hermes-config")
...
## `hermes pairing`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-pairing "Direct link to hermes-pairing")
...
## `hermes skills`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-skills "Direct link to hermes-skills")
...
## `hermes bundles`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-bundles "Direct link to hermes-bundles")

`hermes bundles <subcommand>`

Skill bundles group several skills under one `/<bundle-name>` slash command. Invoking the bundle loads every referenced skill into a single combined user message. Storage: `~/.hermes/skill-bundles/<slug>.yaml`. See [Skill Bundles](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills#skill-bundles) for the YAML schema and behavior.
...
## `hermes curator`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-curator "Direct link to hermes-curator")
...
See [Curator](https://hermes-agent.nousresearch.com/docs/user-guide/features/curator) for behavior and config.

## `hermes fallback`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-fallback "Direct link to hermes-fallback")
...
See [Fallback Providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/fallback-providers).

## `hermes hooks`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-hooks "Direct link to hermes-hooks")
...
See [Hooks](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks) for event signatures and payload shapes.

## `hermes memory`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-memory "Direct link to hermes-memory")
...
## `hermes acp`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-acp "Direct link to hermes-acp")
...
## `hermes mcp`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-mcp "Direct link to hermes-mcp")
...
## `hermes plugins`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-plugins "Direct link to hermes-plugins")
...
## `hermes tools`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-tools "Direct link to hermes-tools")
...
## `hermes computer-use`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-computer-use "Direct link to hermes-computer-use")
...
## `hermes sessions`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-sessions "Direct link to hermes-sessions")
...
## `hermes insights`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-insights "Direct link to hermes-insights")
...
## `hermes claw`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-claw "Direct link to hermes-claw")
...
### What gets migrated[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#what-gets-migrated "Direct link to What gets migrated")
...
### Examples[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#examples-5 "Direct link to Examples")
...
## `hermes dashboard`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-dashboard "Direct link to hermes-dashboard")

`hermes dashboard [options]`

Launch the web dashboard — a browser-based UI for managing configuration, API keys, and monitoring sessions. Requires `pip install hermes-agent[web]` (FastAPI + Uvicorn). The embedded browser Chat tab requires `--tui` plus the `pty` extra. See [Web Dashboard](https://hermes-agent.nousresearch.com/docs/user-guide/features/web-dashboard) for full documentation.
...
`# Default — opens browser to http://127.0.0.1:9119hermes dashboard# Custom port, no browserhermes dashboard --port 8080 --no-open# Enable the browser Chat tabhermes dashboard --tui`

## `hermes profile`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-profile "Direct link to hermes-profile")
...
## `hermes completion`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-completion "Direct link to hermes-completion")
...
## `hermes update`[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#hermes-update "Direct link to hermes-update")
...
## Maintenance commands[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#maintenance-commands "Direct link to Maintenance commands")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/reference/cli-commands#see-also "Direct link to See also")
