...
URL Source: https://hermes-agent.nousresearch.com/docs/reference/profile-commands

Markdown Content:
This page covers all commands related to [Hermes profiles](https://hermes-agent.nousresearch.com/docs/user-guide/profiles). For general CLI commands, see [CLI Commands Reference](https://hermes-agent.nousresearch.com/docs/reference/cli-commands).

## `hermes profile`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile "Direct link to hermes-profile")
...
## `hermes profile list`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-list "Direct link to hermes-profile-list")
...
## `hermes profile use`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-use "Direct link to hermes-profile-use")
...
## `hermes profile create`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-create "Direct link to hermes-profile-create")
...
## `hermes profile describe`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-describe "Direct link to hermes-profile-describe")
...
## `hermes profile delete`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-delete "Direct link to hermes-profile-delete")
...
## `hermes profile show`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-show "Direct link to hermes-profile-show")
...
## `hermes profile alias`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-alias "Direct link to hermes-profile-alias")
...
## `hermes profile rename`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-rename "Direct link to hermes-profile-rename")
...
## `hermes profile export`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-export "Direct link to hermes-profile-export")
...
## `hermes profile import`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-import "Direct link to hermes-profile-import")
...
## Distribution commands[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#distribution-commands "Direct link to Distribution commands")
...
### `hermes profile install`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-install "Direct link to hermes-profile-install")
...
### `hermes profile update`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-update "Direct link to hermes-profile-update")
...
### `hermes profile info`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-profile-info "Direct link to hermes-profile-info")
...
### Private distributions[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#private-distributions "Direct link to Private distributions")
...
### Distribution manifest (`distribution.yaml`)[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#distribution-manifest-distributionyaml "Direct link to distribution-manifest-distributionyaml")
...
### Publishing a distribution[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#publishing-a-distribution "Direct link to Publishing a distribution")
...
## `hermes -p` / `hermes --profile`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes--p--hermes---profile "Direct link to hermes--p--hermes---profile")
...
## `hermes completion`[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#hermes-completion "Direct link to hermes-completion")
...
## See also[​](https://hermes-agent.nousresearch.com/docs/reference/profile-commands#see-also "Direct link to See also")

*   [Profiles User Guide](https://hermes-agent.nousresearch.com/docs/user-guide/profiles)
*   [CLI Commands Reference](https://hermes-agent.nousresearch.com/docs/reference/cli-commands)
*   [FAQ — Profiles section](https://hermes-agent.nousresearch.com/docs/reference/faq#profiles)
