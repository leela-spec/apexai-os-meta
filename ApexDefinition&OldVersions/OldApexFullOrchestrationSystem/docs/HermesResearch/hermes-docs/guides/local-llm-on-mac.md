...
URL Source: https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac
...
## Choosing a model[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#choosing-a-model "Direct link to Choosing a model")
...
## Option A: llama.cpp[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#option-a-llamacpp "Direct link to Option A: llama.cpp")

llama.cpp is the most portable local LLM runtime. On macOS it uses Metal for GPU acceleration out of the box.

### Install[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#install "Direct link to Install")

`brew install llama.cpp`

This gives you the `llama-server` command globally.

### Download the model[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#download-the-model "Direct link to Download the model")
...
### Start the server[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#start-the-server "Direct link to Start the server")
...
### Memory optimization for constrained systems[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#memory-optimization-for-constrained-systems "Direct link to Memory optimization for constrained systems")
...
### Test it[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#test-it "Direct link to Test it")
...
### Get the model name[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#get-the-model-name "Direct link to Get the model name")
...
## Option B: MLX via omlx[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#option-b-mlx-via-omlx "Direct link to Option B: MLX via omlx")
...
### Install[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#install-1 "Direct link to Install")

Download and install from [omlx.ai](https://omlx.ai/). It provides a GUI for model management and a built-in server.

### Download the model[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#download-the-model-1 "Direct link to Download the model")
...
### Start the server[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#start-the-server-1 "Direct link to Start the server")

omlx serves models on `http://127.0.0.1:8000` by default. Start serving from the app UI, or use the CLI if available.

### Test it[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#test-it-1 "Direct link to Test it")
...
### List available models[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#list-available-models "Direct link to List available models")
...
## Benchmarks: llama.cpp vs MLX[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#benchmarks-llamacpp-vs-mlx "Direct link to Benchmarks: llama.cpp vs MLX")
...
### Results[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#results "Direct link to Results")
...
### What this means[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#what-this-means "Direct link to What this means")
...
### Which one should you pick?[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#which-one-should-you-pick "Direct link to Which one should you pick?")
...
## Connect to Hermes[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#connect-to-hermes "Direct link to Connect to Hermes")
...
## Timeouts[​](https://hermes-agent.nousresearch.com/docs/guides/local-llm-on-mac#timeouts "Direct link to Timeouts")
