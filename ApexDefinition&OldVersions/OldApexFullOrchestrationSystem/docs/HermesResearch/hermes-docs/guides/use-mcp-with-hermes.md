...
URL Source: https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes
...
## When should you use MCP?[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#when-should-you-use-mcp "Direct link to When should you use MCP?")
...
## Mental model[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#mental-model "Direct link to Mental model")
...
## Step 1: install MCP support[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#step-1-install-mcp-support "Direct link to Step 1: install MCP support")
...
## Step 2: add one server first[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#step-2-add-one-server-first "Direct link to Step 2: add one server first")
...
## Step 3: verify MCP loaded[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#step-3-verify-mcp-loaded "Direct link to Step 3: verify MCP loaded")
...
### Example: whitelist only what you want[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#example-whitelist-only-what-you-want "Direct link to Example: whitelist only what you want")
...
## WSL2: bridge Hermes in WSL to Windows Chrome[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#wsl2-bridge-hermes-in-wsl-to-windows-chrome "Direct link to WSL2: bridge Hermes in WSL to Windows Chrome")
...
### Why this mode is useful[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#why-this-mode-is-useful "Direct link to Why this mode is useful")
...
### Recommended server[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#recommended-server "Direct link to Recommended server")
...
### Typical prompt[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#typical-prompt "Direct link to Typical prompt")

Once loaded, Hermes can use the MCP-prefixed browser tools directly. For example:

`调用 MCP 工具 mcp_chrome_devtools_win_list_pages，列出当前浏览器标签页。`

### When `/browser connect` is the wrong tool[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#when-browser-connect-is-the-wrong-tool "Direct link to when-browser-connect-is-the-wrong-tool")
...
### Known pitfalls[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#known-pitfalls "Direct link to Known pitfalls")
...
### Example: blacklist dangerous actions[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#example-blacklist-dangerous-actions "Direct link to Example: blacklist dangerous actions")

`mcp_servers:  stripe:    url: "https://mcp.stripe.com"    headers:      Authorization: "Bearer ***"    tools:      exclude: [delete_customer, refund_payment]`

### Example: disable utility wrappers too[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#example-disable-utility-wrappers-too "Direct link to Example: disable utility wrappers too")

`mcp_servers:  docs:    url: "https://mcp.docs.example.com"    tools:      prompts: false      resources: false`

## What does filtering actually affect?[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#what-does-filtering-actually-affect "Direct link to What does filtering actually affect?")
...
### Utility wrappers you may see[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#utility-wrappers-you-may-see "Direct link to Utility wrappers you may see")
...
## Common patterns[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#common-patterns "Direct link to Common patterns")

### Pattern 1: local project assistant[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#pattern-1-local-project-assistant "Direct link to Pattern 1: local project assistant")
...
### Pattern 2: GitHub triage assistant[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#pattern-2-github-triage-assistant "Direct link to Pattern 2: GitHub triage assistant")
...
### Pattern 3: internal API assistant[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#pattern-3-internal-api-assistant "Direct link to Pattern 3: internal API assistant")
...
### Pattern 4: documentation / knowledge servers[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#pattern-4-documentation--knowledge-servers "Direct link to Pattern 4: documentation / knowledge servers")
...
## Tutorial: end-to-end setup with filtering[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#tutorial-end-to-end-setup-with-filtering "Direct link to Tutorial: end-to-end setup with filtering")

Here is a practical progression.

### Phase 1: add GitHub MCP with a tight whitelist[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#phase-1-add-github-mcp-with-a-tight-whitelist "Direct link to Phase 1: add GitHub MCP with a tight whitelist")
...
### Phase 2: expand only when needed[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#phase-2-expand-only-when-needed "Direct link to Phase 2: expand only when needed")
...
### Phase 3: add a second server with different policy[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#phase-3-add-a-second-server-with-different-policy "Direct link to Phase 3: add a second server with different policy")
...
## Safe usage recommendations[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#safe-usage-recommendations "Direct link to Safe usage recommendations")

### Prefer allowlists for dangerous systems[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#prefer-allowlists-for-dangerous-systems "Direct link to Prefer allowlists for dangerous systems")
...
### Disable unused utilities[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#disable-unused-utilities "Direct link to Disable unused utilities")

If you do not want the model browsing server-provided resources/prompts, turn them off:

`tools:  resources: false  prompts: false`

### Keep servers scoped narrowly[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#keep-servers-scoped-narrowly "Direct link to Keep servers scoped narrowly")
...
### Reload after config changes[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#reload-after-config-changes "Direct link to Reload after config changes")
...
## Troubleshooting by symptom[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#troubleshooting-by-symptom "Direct link to Troubleshooting by symptom")

### "The server connects but the tools I expected are missing"[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#the-server-connects-but-the-tools-i-expected-are-missing "Direct link to \"The server connects but the tools I expected are missing\"")
...
### "The server is configured but nothing loads"[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#the-server-is-configured-but-nothing-loads "Direct link to \"The server is configured but nothing loads\"")
...
### "Why do I see fewer tools than the MCP server advertises?"[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#why-do-i-see-fewer-tools-than-the-mcp-server-advertises "Direct link to \"Why do I see fewer tools than the MCP server advertises?\"")
...
### "How do I remove an MCP server without deleting the config?"[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#how-do-i-remove-an-mcp-server-without-deleting-the-config "Direct link to \"How do I remove an MCP server without deleting the config?\"")
...
## Recommended first MCP setups[​](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes#recommended-first-mcp-setups "Direct link to Recommended first MCP setups")
