...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/acp
...
### Browser tools (optional)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/acp#browser-tools-optional "Direct link to Browser tools (optional)")
...
### Session-scoped edit auto-approval[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/acp#session-scoped-edit-auto-approval "Direct link to Session-scoped edit auto-approval")
...
### Zed registry launcher cannot find uv[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/acp#zed-registry-launcher-cannot-find-uv "Direct link to Zed registry launcher cannot find uv")
