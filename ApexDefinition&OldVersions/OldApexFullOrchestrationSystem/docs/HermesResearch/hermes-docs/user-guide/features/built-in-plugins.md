...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins
...
## How discovery works[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#how-discovery-works "Direct link to How discovery works")
...
## Bundled plugins are opt-in[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#bundled-plugins-are-opt-in "Direct link to Bundled plugins are opt-in")
...
## Currently shipped[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#currently-shipped "Direct link to Currently shipped")
...
| `kanban/dashboard` | dashboard tab | Kanban board UI for the multi-agent dispatcher — tasks, comments, fan-out, board switching. See [Kanban Multi-Agent](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban). |

Memory providers (`plugins/memory/*`) and context engines (`plugins/context_engine/*`) are listed separately on [Memory Providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory-providers) — they're managed through `hermes memory` and `hermes plugins` respectively. The full per-plugin detail for the two long-running hooks-based plugins follows.

### disk-cleanup[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#disk-cleanup "Direct link to disk-cleanup")
...
### security-guidance[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#security-guidance "Direct link to security-guidance")
...
### observability/langfuse[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#observabilitylangfuse "Direct link to observability/langfuse")
...
### google_meet[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#google_meet "Direct link to google_meet")
...
### hermes-achievements[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#hermes-achievements "Direct link to hermes-achievements")
...
## Adding a bundled plugin[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/built-in-plugins#adding-a-bundled-plugin "Direct link to Adding a bundled plugin")
