...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban
...
> **Want a walkthrough?** Read the [Kanban tutorial](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial) — four user stories (solo dev, fleet farming, role pipeline with retry, circuit breaker) with dashboard screenshots of each. This page is the reference; the tutorial is the narrative.
...
### Two surfaces: the model talks through tools, you talk through the CLI[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#two-surfaces-the-model-talks-through-tools-you-talk-through-the-cli "Direct link to Two surfaces: the model talks through tools, you talk through the CLI")

The board has two front doors, both backed by the same `~/.hermes/kanban.db`:

*   **Agents drive the board through a dedicated `kanban_*` toolset** — `kanban_show`, `kanban_list`, `kanban_complete`, `kanban_block`, `kanban_heartbeat`, `kanban_comment`, `kanban_create`, `kanban_link`, `kanban_unblock`. The dispatcher spawns each worker with these tools already in its schema; orchestrator profiles can also enable the `kanban` toolset explicitly. The model reads and routes tasks by calling tools directly, _not_ by shelling out to `hermes kanban`. See [How workers interact with the board](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#how-workers-interact-with-the-board) below.
...
## Kanban vs. `delegate_task`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#kanban-vs-delegate_task "Direct link to kanban-vs-delegate_task")
...
## Core concepts[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#core-concepts "Direct link to Core concepts")

*   **Board** — a standalone queue of tasks with its own SQLite DB, workspaces directory, and dispatcher loop. A single install can have many boards (e.g. one per project, repo, or domain); see [Boards (multi-project)](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#boards-multi-project) below. Single-project users stay on the `default` board and never see the word "board" outside this docs section.
...
## Boards (multi-project)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#boards-multi-project "Direct link to Boards (multi-project)")
...
### Managing boards from the CLI[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#managing-boards-from-the-cli "Direct link to Managing boards from the CLI")
...
### Managing boards from the dashboard[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#managing-boards-from-the-dashboard "Direct link to Managing boards from the dashboard")
...
## Quick start[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#quick-start "Direct link to Quick start")

The commands below are **you** (the human) setting up the board and creating tasks. Once a task is assigned, the dispatcher spawns the assigned profile as a worker, and from there **the model drives the task through `kanban_*` tool calls, not CLI commands** — see [How workers interact with the board](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#how-workers-interact-with-the-board).
...
### Gateway-embedded dispatcher (default)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#gateway-embedded-dispatcher-default "Direct link to Gateway-embedded dispatcher (default)")
...
### Idempotent create (for automation / webhooks)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#idempotent-create-for-automation--webhooks "Direct link to Idempotent create (for automation / webhooks)")
...
### Bulk CLI verbs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#bulk-cli-verbs "Direct link to Bulk CLI verbs")
...
## How workers interact with the board[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#how-workers-interact-with-the-board "Direct link to How workers interact with the board")
...
### Why tools instead of shelling to `hermes kanban`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#why-tools-instead-of-shelling-to-hermes-kanban "Direct link to why-tools-instead-of-shelling-to-hermes-kanban")
...
### Recommended handoff evidence[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#recommended-handoff-evidence "Direct link to Recommended handoff evidence")
...
### The worker skill[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#the-worker-skill "Direct link to The worker skill")
...
### The orchestrator skill[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#the-orchestrator-skill "Direct link to The orchestrator skill")
...
## Dashboard (GUI)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#dashboard-gui "Direct link to Dashboard (GUI)")
...
### What the plugin gives you[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#what-the-plugin-gives-you "Direct link to What the plugin gives you")
...
### Auto vs Manual orchestration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#auto-vs-manual-orchestration "Direct link to Auto vs Manual orchestration")
...
### Architecture[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#architecture "Direct link to Architecture")
...
### REST surface[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#rest-surface "Direct link to REST surface")
...
| `GET` | `/orchestration` | Read the kanban orchestration settings (`orchestrator_profile`, `default_assignee`, `auto_decompose`) plus the _resolved_ effective values after fallbacks. |
...
### Dashboard config[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#dashboard-config "Direct link to Dashboard config")
...
### Security model[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#security-model "Direct link to Security model")
...
### Live updates[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#live-updates "Direct link to Live updates")
...
### Extending it[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#extending-it "Direct link to Extending it")
...
### Scope boundary[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#scope-boundary "Direct link to Scope boundary")
...
### Concurrency, scheduling, and child promotion config[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#concurrency-scheduling-and-child-promotion-config "Direct link to Concurrency, scheduling, and child promotion config")
...
### Scheduled task starts (`scheduled_at`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#scheduled-task-starts-scheduled_at "Direct link to scheduled-task-starts-scheduled_at")
...
### Respawn guard[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#respawn-guard "Direct link to Respawn guard")

The dispatcher refuses to re-spawn a ready task when it hit a quota/auth/429 error on the previous run (`blocker_auth`), or completed a run successfully within the guard window (`recent_success`), or a recent task comment links to a GitHub PR (`active_pr`). This prevents repeat worker storms on the same bug or task while a human catches up. See the `respawn_guarded` row in the [event reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#event-reference).

### Drag-to-delete and bulk delete (dashboard)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#drag-to-delete-and-bulk-delete-dashboard "Direct link to Drag-to-delete and bulk delete (dashboard)")
...
### Worker visibility endpoints[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#worker-visibility-endpoints "Direct link to Worker visibility endpoints")
...
### Kanban Swarm topology helper[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#kanban-swarm-topology-helper "Direct link to Kanban Swarm topology helper")
...
## `/kanban` slash command[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#kanban-slash-command "Direct link to kanban-slash-command")
...
### Mid-run usage: `/kanban` bypasses the running-agent guard[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#mid-run-usage-kanban-bypasses-the-running-agent-guard "Direct link to mid-run-usage-kanban-bypasses-the-running-agent-guard")
...
### Auto-subscribe on `/kanban create` (gateway only)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#auto-subscribe-on-kanban-create-gateway-only "Direct link to auto-subscribe-on-kanban-create-gateway-only")
...
### Output truncation in messaging[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#output-truncation-in-messaging "Direct link to Output truncation in messaging")
...
### Autocomplete[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#autocomplete "Direct link to Autocomplete")
...
## Collaboration patterns[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#collaboration-patterns "Direct link to Collaboration patterns")
...
## Multi-tenant usage[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#multi-tenant-usage "Direct link to Multi-tenant usage")
...
## Gateway notifications[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#gateway-notifications "Direct link to Gateway notifications")
...
## Runs — one row per attempt[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#runs--one-row-per-attempt "Direct link to Runs — one row per attempt")
...
### Forward compatibility[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#forward-compatibility "Direct link to Forward compatibility")
...
## Event reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#event-reference "Direct link to Event reference")
...
## Out of scope[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#out-of-scope "Direct link to Out of scope")
...
## Design spec[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#design-spec "Direct link to Design spec")
