...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial

Published Time: Fri, 29 May 2026 12:35:12 GMT

Markdown Content:
A walkthrough of the four use-cases the Hermes Kanban system was designed for, with the dashboard open in a browser. If you haven't read the [Kanban overview](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban) yet, start there — this assumes you know what a task, run, assignee, and dispatcher are.

## Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#setup "Direct link to Setup")
...
## The board at a glance[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#the-board-at-a-glance "Direct link to The board at a glance")

![Image 1: Kanban board overview](https://hermes-agent.nousresearch.com/docs/assets/images/01-board-overview-dd98ac39283d95534d6df59f90df98b0.png)
...
### Flat view[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#flat-view "Direct link to Flat view")
...
![Image 2: Board with lanes by profile off](https://hermes-agent.nousresearch.com/docs/assets/images/02-board-flat-019a7cf4f943c0ff4d95ffa7d579bf25.png)

## Story 1 — Solo dev shipping a feature[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#story-1--solo-dev-shipping-a-feature "Direct link to Story 1 — Solo dev shipping a feature")
...
![Image 3: Solo dev — completed schema task drawer](https://hermes-agent.nousresearch.com/docs/assets/images/03-drawer-schema-task-217f2993df9ebe7c0f2a678df97d934e.png)
...
## Story 2 — Fleet farming[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#story-2--fleet-farming "Direct link to Story 2 — Fleet farming")
...
![Image 4: Fleet view filtered to transcribe tasks](https://hermes-agent.nousresearch.com/docs/assets/images/07-fleet-transcribes-cf7345a3270df63f9336252cada8da61.png)
...
## Story 3 — Role pipeline with retry[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#story-3--role-pipeline-with-retry "Direct link to Story 3 — Role pipeline with retry")
...
![Image 5: Pipeline view for a multi-role feature](https://hermes-agent.nousresearch.com/docs/assets/images/08-pipeline-auth-2dc4dcc631cf371f649ad70ab1e71611.png)
...
![Image 6: Implementation task with two runs — blocked then completed](https://hermes-agent.nousresearch.com/docs/assets/images/04b-drawer-retry-history-scrolled-356e4195a55572cfc522c5236f02c594.png)
...
![Image 7: Reviewer&#39;s drawer view of the pipeline](https://hermes-agent.nousresearch.com/docs/assets/images/09-drawer-pipeline-review-12ea45e97703570d5e889812347a0778.png)
...
## Story 4 — Circuit breaker and crash recovery[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#story-4--circuit-breaker-and-crash-recovery "Direct link to Story 4 — Circuit breaker and crash recovery")
...
### Circuit breaker — permanent-looking failure[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#circuit-breaker--permanent-looking-failure "Direct link to Circuit breaker — permanent-looking failure")
...
![Image 8: Circuit breaker — 2 spawn_failed + 1 gave_up](https://hermes-agent.nousresearch.com/docs/assets/images/11-drawer-gave-up-04cdec442b239748a9904b8651efde1d.png)
...
### Crash recovery — worker dies mid-flight[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#crash-recovery--worker-dies-mid-flight "Direct link to Crash recovery — worker dies mid-flight")
...
![Image 9: Crash and recovery — 1 crashed + 1 completed](https://hermes-agent.nousresearch.com/docs/assets/images/06-drawer-crash-recovery-17edcbea131d965bb8dc7283e5622e35.png)
...
## Inspecting a task currently running[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#inspecting-a-task-currently-running "Direct link to Inspecting a task currently running")
...
![Image 10: Claimed, in-flight task](https://hermes-agent.nousresearch.com/docs/assets/images/10-drawer-in-flight-0b6c924e986c7862439f00d776e432f4.png)
...
## Next steps[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial#next-steps "Direct link to Next steps")

*   [Kanban overview](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban) — the full data model, event vocabulary, and CLI reference.
