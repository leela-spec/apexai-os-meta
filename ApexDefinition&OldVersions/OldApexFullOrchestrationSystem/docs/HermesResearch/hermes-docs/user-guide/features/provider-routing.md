...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/provider-routing

Published Time: Fri, 29 May 2026 02:02:12 GMT
...
Traffic routed through [Nous Portal](https://hermes-agent.nousresearch.com/docs/integrations/nous-portal) still respects per-model routing and priority configs — and Portal subscribers get 10% off token-billed providers.
