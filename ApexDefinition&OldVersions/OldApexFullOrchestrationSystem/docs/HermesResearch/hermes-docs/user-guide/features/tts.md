...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/tts
...
## Text-to-Speech[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#text-to-speech "Direct link to Text-to-Speech")
...
### Platform Delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#platform-delivery "Direct link to Platform Delivery")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#configuration "Direct link to Configuration")
...
### Input length limits[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#input-length-limits "Direct link to Input length limits")
...
### Telegram Voice Bubbles & ffmpeg[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#telegram-voice-bubbles--ffmpeg "Direct link to Telegram Voice Bubbles & ffmpeg")
...
### xAI Custom Voices (voice cloning)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#xai-custom-voices-voice-cloning "Direct link to xAI Custom Voices (voice cloning)")
...
### Piper (local, 44 languages)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#piper-local-44-languages "Direct link to Piper (local, 44 languages)")
...
### Custom command providers[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#custom-command-providers "Direct link to Custom command providers")
...
#### Example: Doubao (Chinese seed-tts-2.0)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#example-doubao-chinese-seed-tts-20 "Direct link to Example: Doubao (Chinese seed-tts-2.0)")
...
Credentials come from your shell environment (`VOLCENGINE_APP_ID` / `VOLCENGINE_ACCESS_TOKEN`) or `~/.doubao-speech/config.yaml`. Pick a voice by adding `--voice zh-female-warm` (or any other alias from `doubao-speech list-voices`) to the command. `doubao-speech` also bundles streaming ASR — see the [STT section below](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#example-doubao--volcengine-asr) for Hermes integration. Source and full docs: [github.com/Hypnus-Yuan/doubao-speech](https://github.com/Hypnus-Yuan/doubao-speech).

#### Placeholders[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#placeholders "Direct link to Placeholders")
...
#### Optional keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#optional-keys "Direct link to Optional keys")
...
#### Behavior notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#behavior-notes "Direct link to Behavior notes")
...
#### Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#security "Direct link to Security")
...
### Python plugin providers[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#python-plugin-providers "Direct link to Python plugin providers")
...
#### When to pick which[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#when-to-pick-which "Direct link to When to pick which")
...
#### Minimal plugin[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#minimal-plugin "Direct link to Minimal plugin")
...
#### Optional hooks[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#optional-hooks "Direct link to Optional hooks")
...
## Voice Message Transcription (STT)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#voice-message-transcription-stt "Direct link to Voice Message Transcription (STT)")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#configuration-1 "Direct link to Configuration")
...
### Provider Details[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#provider-details "Direct link to Provider Details")
...
#### Example: Doubao / Volcengine ASR[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#example-doubao--volcengine-asr "Direct link to Example: Doubao / Volcengine ASR")

If you use [`doubao-speech`](https://pypi.org/project/doubao-speech/) for Doubao TTS (see [above](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#example-doubao-chinese-seed-tts-20)), the same package handles speech-to-text via the local-command STT surface:
...
### Fallback Behavior[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#fallback-behavior "Direct link to Fallback Behavior")
...
### STT custom command providers[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-custom-command-providers "Direct link to STT custom command providers")
...
Declare one or more providers under `stt.providers.<name>` and switch between them with `stt.provider: <name>` — same shape as the TTS [command-provider registry](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#custom-command-providers), adapted for the input=audio → output=transcript direction.
...
#### STT placeholders[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-placeholders "Direct link to STT placeholders")
...
#### How the transcript is read back[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#how-the-transcript-is-read-back "Direct link to How the transcript is read back")
...
#### STT command-provider optional keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-command-provider-optional-keys "Direct link to STT command-provider optional keys")
...
#### STT command-provider behavior notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-command-provider-behavior-notes "Direct link to STT command-provider behavior notes")
...
#### STT command-provider security[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-command-provider-security "Direct link to STT command-provider security")
...
### Python plugin providers (STT)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#python-plugin-providers-stt "Direct link to Python plugin providers (STT)")
...
#### When to pick which (STT)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#when-to-pick-which-stt "Direct link to When to pick which (STT)")
...
#### Resolution order[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#resolution-order "Direct link to Resolution order")

1.   **`stt.provider` is a built-in name** → built-in dispatch. **Always wins.**
2.   **`stt.provider` matches `stt.providers.<name>` with `command:` set** → command-provider runner (see [STT custom command providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#stt-custom-command-providers)). Wins over a same-name plugin.
...
#### Per-provider config namespace[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#per-provider-config-namespace "Direct link to Per-provider config namespace")
...
#### Minimal plugin[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#minimal-plugin-1 "Direct link to Minimal plugin")
...
#### Optional hooks[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tts#optional-hooks-1 "Direct link to Optional hooks")
