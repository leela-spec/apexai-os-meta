...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/sessions
...
![Image 1: Stylized preview of the Previous Conversation recap panel shown when resuming a Hermes session.](https://hermes-agent.nousresearch.com/img/docs/session-recap.svg)
