...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram
...
## Step 1: Create a Bot via BotFather[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-1-create-a-bot-via-botfather "Direct link to Step 1: Create a Bot via BotFather")
...
## Step 2: Customize Your Bot (Optional)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-2-customize-your-bot-optional "Direct link to Step 2: Customize Your Bot (Optional)")
...
## Step 3: Privacy Mode (Critical for Groups)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups "Direct link to Step 3: Privacy Mode (Critical for Groups)")
...
### How to disable privacy mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-to-disable-privacy-mode "Direct link to How to disable privacy mode")
...
### Observe group chatter without auto-replying[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#observe-group-chatter-without-auto-replying "Direct link to Observe group chatter without auto-replying")
...
## Step 4: Find Your User ID[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-4-find-your-user-id "Direct link to Step 4: Find Your User ID")
...
## Step 5: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-5-configure-hermes "Direct link to Step 5: Configure Hermes")

### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#option-a-interactive-setup-recommended "Direct link to Option A: Interactive Setup (Recommended)")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#option-b-manual-configuration "Direct link to Option B: Manual Configuration")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#start-the-gateway "Direct link to Start the Gateway")

`hermes gateway`

The bot should come online within seconds. Send it a message on Telegram to verify.

## Sending Generated Files from Docker-backed Terminals[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#sending-generated-files-from-docker-backed-terminals "Direct link to Sending Generated Files from Docker-backed Terminals")
...
### Supported `MEDIA:` file extensions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#supported-media-file-extensions "Direct link to supported-media-file-extensions")
...
## Webhook Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#webhook-mode "Direct link to Webhook Mode")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration "Direct link to Configuration")
...
### Cloud deployment example (Fly.io)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#cloud-deployment-example-flyio "Direct link to Cloud deployment example (Fly.io)")
...
## Proxy Support[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#proxy-support "Direct link to Proxy Support")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#home-channel "Direct link to Home Channel")
...
### Cron deliveries in topic mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#cron-deliveries-in-topic-mode "Direct link to Cron deliveries in topic mode")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#voice-messages "Direct link to Voice Messages")

### Incoming Voice (Speech-to-Text)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#incoming-voice-speech-to-text "Direct link to Incoming Voice (Speech-to-Text)")
...
#### Skipping STT: pass the raw audio file to the agent[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#skipping-stt-pass-the-raw-audio-file-to-the-agent "Direct link to Skipping STT: pass the raw audio file to the agent")
...
This pairs naturally with the [local Bot API server](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#large-files-20mb-via-local-bot-api-server) section below, which lifts Telegram's 20MB getFile ceiling to 2GB — useful when the recordings you want to process are longer than a couple of minutes.

### Outgoing Voice (Text-to-Speech)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#outgoing-voice-text-to-speech "Direct link to Outgoing Voice (Text-to-Speech)")
...
## Large Files (>20MB) via Local Bot API Server[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#large-files-20mb-via-local-bot-api-server "Direct link to Large Files (>20MB) via Local Bot API Server")
...
### Step 1: Obtain Telegram API credentials[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-1-obtain-telegram-api-credentials "Direct link to Step 1: Obtain Telegram API credentials")
...
### Step 2: Run the telegram-bot-api server[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-2-run-the-telegram-bot-api-server "Direct link to Step 2: Run the telegram-bot-api server")
...
### Step 3: Log the bot out of the public API (one-time)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-3-log-the-bot-out-of-the-public-api-one-time "Direct link to Step 3: Log the bot out of the public API (one-time)")
...
### Step 4: Point Hermes at the local server[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-4-point-hermes-at-the-local-server "Direct link to Step 4: Point Hermes at the local server")
...
### Step 5: `local_mode` — file access on disk[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-5-local_mode--file-access-on-disk "Direct link to step-5-local_mode--file-access-on-disk")
...
### Step 6: Test it[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-6-test-it "Direct link to Step 6: Test it")
...
## Group Chat Usage[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-chat-usage "Direct link to Group Chat Usage")

Hermes Agent works in Telegram group chats with a few considerations:

*   **Privacy mode** determines what messages the bot can see (see [Step 3](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#step-3-privacy-mode-critical-for-groups))
...
### Multiple Hermes bots in one group[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#multiple-hermes-bots-in-one-group "Direct link to Multiple Hermes bots in one group")
...
### Troubleshooting: works in DMs but not groups[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#troubleshooting-works-in-dms-but-not-groups "Direct link to Troubleshooting: works in DMs but not groups")
...
### Example group trigger configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#example-group-trigger-configuration "Direct link to Example group trigger configuration")
...
### Notes on `mention_patterns`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#notes-on-mention_patterns "Direct link to notes-on-mention_patterns")
...
## Private Chat Topics (Bot API 9.4)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#private-chat-topics-bot-api-94 "Direct link to Private Chat Topics (Bot API 9.4)")
...
### Use case[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#use-case "Direct link to Use case")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-1 "Direct link to Configuration")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works "Direct link to How it works")
...
### Root DM handling[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#root-dm-handling "Direct link to Root DM handling")
...
### Skill binding[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#skill-binding "Direct link to Skill binding")
...
## Multi-session DM mode (`/topic`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#multi-session-dm-mode-topic "Direct link to multi-session-dm-mode-topic")
...
### `/topic` subcommands[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#topic-subcommands "Direct link to topic-subcommands")
...
### DM Topics vs Multi-session DM mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#dm-topics-vs-multi-session-dm-mode "Direct link to DM Topics vs Multi-session DM mode")
...
### Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#prerequisites "Direct link to Prerequisites")
...
### Activation flow[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#activation-flow "Direct link to Activation flow")
...
### Creating a new topic (end-user flow)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#creating-a-new-topic-end-user-flow "Direct link to Creating a new topic (end-user flow)")
...
### Auto-renamed topics[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#auto-renamed-topics "Direct link to Auto-renamed topics")
...
### `/new` inside a topic[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#new-inside-a-topic "Direct link to new-inside-a-topic")
...
### Restoring a previous session[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#restoring-a-previous-session "Direct link to Restoring a previous session")
...
### `/topic` inside a topic (no argument)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#topic-inside-a-topic-no-argument "Direct link to topic-inside-a-topic-no-argument")

Shows the current topic's binding: session title, session ID, and hints for `/new` vs creating another topic.

### Under the hood[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#under-the-hood "Direct link to Under the hood")
...
### Disabling multi-session mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#disabling-multi-session-mode "Direct link to Disabling multi-session mode")
...
### Downgrading Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#downgrading-hermes "Direct link to Downgrading Hermes")
...
## Group Forum Topic Skill Binding[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-forum-topic-skill-binding "Direct link to Group Forum Topic Skill Binding")
...
### Use case[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#use-case-1 "Direct link to Use case")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-2 "Direct link to Configuration")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works-1 "Direct link to How it works")
...
### Differences from DM Topics[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#differences-from-dm-topics "Direct link to Differences from DM Topics")
...
## Recent Bot API Features[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#recent-bot-api-features "Direct link to Recent Bot API Features")

*   **Bot API 9.4 (Feb 2026):** Private Chat Topics — bots can create forum topics in 1-on-1 DM chats via `createForumTopic`. Hermes uses this for two distinct features: operator-curated [Private Chat Topics](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#private-chat-topics-bot-api-94) (config-driven, fixed topic list) and user-driven [Multi-session DM mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#multi-session-dm-mode-topic) (activated by `/topic`, unlimited user-created topics).
...
### Streaming transport (`gateway.streaming.transport`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#streaming-transport-gatewaystreamingtransport "Direct link to streaming-transport-gatewaystreamingtransport")
...
`gateway:  streaming:    enabled: true    transport: edit    # edit | auto | draft | off`
...
## Rendering: Tables and Link Previews[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#rendering-tables-and-link-previews "Direct link to Rendering: Tables and Link Previews")
...
## Group Allowlisting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#group-allowlisting "Direct link to Group Allowlisting")
...
### Migration from before PR #17686[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#migration-from-before-pr-17686 "Direct link to Migration from before PR #17686")
...
### Guest @mention bypass (`guest_mode`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#guest-mention-bypass-guest_mode "Direct link to guest-mention-bypass-guest_mode")
...
## Slash Command Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#slash-command-access-control "Direct link to Slash Command Access Control")
...
## Interactive Model Picker[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#interactive-model-picker "Direct link to Interactive Model Picker")
...
## DNS-over-HTTPS Fallback IPs[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#dns-over-https-fallback-ips "Direct link to DNS-over-HTTPS Fallback IPs")
...
### How it works[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#how-it-works-2 "Direct link to How it works")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-3 "Direct link to Configuration")
...
## Proxy Support[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#proxy-support-1 "Direct link to Proxy Support")
...
### Supported variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#supported-variables "Direct link to Supported variables")
...
### Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#configuration-4 "Direct link to Configuration")
...
## Message Reactions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#message-reactions "Direct link to Message Reactions")
...
## Per-Channel Prompts[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#per-channel-prompts "Direct link to Per-Channel Prompts")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#troubleshooting "Direct link to Troubleshooting")
...
## Exec Approval[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#exec-approval "Direct link to Exec Approval")
...
## Interactive Prompts (clarify)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#interactive-prompts-clarify "Direct link to Interactive Prompts (clarify)")
...
## Push notification volume[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#push-notification-volume "Direct link to Push notification volume")
...
## Status messages edited in place[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#status-messages-edited-in-place "Direct link to Status messages edited in place")
...
## Pin incoming user message during agent turn[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#pin-incoming-user-message-during-agent-turn "Direct link to Pin incoming user message during agent turn")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/telegram#security "Direct link to Security")
