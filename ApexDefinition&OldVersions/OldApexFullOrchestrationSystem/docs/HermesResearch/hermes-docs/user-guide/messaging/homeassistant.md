...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#setup "Direct link to Setup")

### 1. Create a Long-Lived Access Token[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#1-create-a-long-lived-access-token "Direct link to 1. Create a Long-Lived Access Token")
...
### 2. Configure Environment Variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#2-configure-environment-variables "Direct link to 2. Configure Environment Variables")
...
### 3. Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#3-start-the-gateway "Direct link to 3. Start the Gateway")

`hermes gateway`

Home Assistant will appear as a connected platform alongside any other messaging platforms (Telegram, Discord, etc.).

## Available Tools[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#available-tools "Direct link to Available Tools")

Hermes Agent registers four tools for smart home control:

### `ha_list_entities`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#ha_list_entities "Direct link to ha_list_entities")
...
### `ha_get_state`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#ha_get_state "Direct link to ha_get_state")
...
### `ha_list_services`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#ha_list_services "Direct link to ha_list_services")
...
### `ha_call_service`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#ha_call_service "Direct link to ha_call_service")
...
## Gateway Platform: Real-Time Events[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#gateway-platform-real-time-events "Direct link to Gateway Platform: Real-Time Events")
...
### Event Filtering[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#event-filtering "Direct link to Event Filtering")
...
### Event Formatting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#event-formatting "Direct link to Event Formatting")
...
### Agent Responses[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#agent-responses "Direct link to Agent Responses")
...
### Connection Management[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#connection-management "Direct link to Connection Management")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#security "Direct link to Security")
...
## Example Automations[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#example-automations "Direct link to Example Automations")

### Morning Routine[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#morning-routine "Direct link to Morning Routine")
...
### Security Check[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#security-check "Direct link to Security Check")
...
### Reactive Automation (via Gateway Events)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#reactive-automation-via-gateway-events "Direct link to Reactive Automation (via Gateway Events)")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/homeassistant#troubleshooting "Direct link to Troubleshooting")
