...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/slack
...
1.   Generate the manifest:`hermes slack manifest --write` This writes `~/.hermes/slack-manifest.json` and prints paste-in instructions.
