...
| MIS-INF-010 | Appendix TODO fossilization | A TODO remains active after the work was integrated, rejected, split, or deferred. | Update appendix status whenever candidate state changes. |
...
- **Trap:** Markdown tables are machine-readable enough for this phase unless repeated query failures justify JSON/YAML sidecars.
...
- **Check:** Did each candidate transition preserve source ID, decision, target, and status?
