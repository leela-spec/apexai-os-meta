# Flow Execution Cards — Day 1 (MON) [Variations A / B / C]

## 🔹 Option A (Engineering Specification)
- **F1 Card:** `[FLOW-LHTL-D1]` Input: `MasterOfArts/LHTL/`. Schema: ActiveRecallProtocol_v1. Output: `lhtl_learning_os.md`.
- **F2 Card:** `[FLOW-SHK-D1]` Input: `MasterOfArts/SuperHeroKids/`. Schema: WorkshopLessonPlan_v1. Output: `superherokids_workshops.md`.
- **F3 Card:** `[FLOW-IPOS-D1]` Input: `Investment/configs/registry_120.yaml`. Schema: PanderaIndicatorSchema. Output: `configs/registry.yaml`.
- **F4 Card:** `[FLOW-APEX-D1]` Input: `apex-meta/orchestration/`. Schema: StateLedger_v1. Output: Session Mutation.
