# Flow Execution Cards — Day 3 (WED) [Variations A / B / C]

## 🔹 Option A (Engineering Specification)
- **F1 Card:** `[FLOW-LHTL-D3]` Input: `MasterOfArts/LHTL/`. Schema: ActiveRecallProtocol_v1. Output: `lhtl_learning_os.md`.
- **F2 Card:** `[FLOW-SHK-D3]` Input: `MasterOfArts/SuperHeroKids/`. Schema: WorkshopLessonPlan_v1. Output: `superherokids_workshops.md`.
- **F3 Card:** `[FLOW-IPOS-D3]` Input: `Investment/configs/registry_120.yaml`. Schema: PanderaIndicatorSchema. Output: `configs/registry.yaml`.
- **F4 Card:** `[FLOW-APEX-D3]` Input: `apex-meta/orchestration/`. Schema: StateLedger_v1. Output: Session Mutation.
