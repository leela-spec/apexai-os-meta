...
- related existing records: `fable-execution-best-practices.md` (execution lessons; §8 holds a similar "check before deleting" lesson → likely lane), `prompts/PromptAnswers/research-integration-note.md` §4 ("Neither answer was repo-bound") — same finding from the artifact side (confidence: high)
- project links: PromptEngineer skill (`.claude/skills/PromptEngineer/ProviderStyleContract_ChatGPT.md`, deep-research section) as a *candidate* second surface (confidence: low — see R1)
