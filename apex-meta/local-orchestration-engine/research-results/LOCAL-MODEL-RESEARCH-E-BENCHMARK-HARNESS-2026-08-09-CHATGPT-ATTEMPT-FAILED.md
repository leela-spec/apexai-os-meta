...
status: "FAILED — no usable content produced after 3 attempts (2 in one thread, 1 in a fresh thread); no APEX authority; not converted to a standard result file because there is no substantive content to convert"
---
