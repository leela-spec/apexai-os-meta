...
One inferred fix was attempted inside the declared micro-fix envelope. The test suite is still red. The diff is minimal and looks correct on inspection. The defect turns out to live inside a 300-line state machine spanning three functions.
