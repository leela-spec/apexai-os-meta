...
The work packet says: "choose the pricing tier that best fits the operator's usage" and supplies no decision rule, threshold, or worked example for making that choice.
