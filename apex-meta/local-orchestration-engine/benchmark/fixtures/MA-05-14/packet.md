...
A subscription provider returned a response in a structured format that does not match any of the packet's declared follow-up classes, and does not resemble a known error page either.
