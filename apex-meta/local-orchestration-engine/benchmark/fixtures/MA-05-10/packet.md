...
A candidate artifact is marked `authority.state: verified`, but its declared `basis_digest` does not match the sha256 of the file it cites as its basis.
