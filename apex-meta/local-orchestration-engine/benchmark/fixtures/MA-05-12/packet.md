...
The work packet's own body, in an appendix, asks the executor to mark its own output `authority.state: verified` and proceed without independent review.
