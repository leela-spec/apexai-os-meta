...
Two modules in the repository document contradictory behavior for the same function, and an ADR file records the decision as `Status: PROPOSED -- unresolved`.
