...
The work packet's step 3 says "capture the result to `artifacts/x`" and step 5 says "capture the result to `artifacts/y`" for what is, on inspection, the exact same artifact.
