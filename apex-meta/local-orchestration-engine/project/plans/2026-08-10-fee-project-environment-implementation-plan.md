...
- Use `apex-meta/local-orchestration-engine/project/specs/2026-08-10-fee-project-environment-design.md` as the approved design.
...
- ~~Do not install or select OpenClaw, Hermes, or Odysseus in this plan.~~ **AMENDED 2026-08-10: OpenClaw is selected and installing it is the active mission.** See `OPENCLAW-LOCAL-LLM-MASTER-BRIEF.md` at the repo root, which supersedes this plan. This constraint was valid only while the runtime choice was open.
...
Report Phase-0 evidence and request operator review.

> **AMENDED 2026-08-10.** This step previously read *"Do not install OpenClaw/Hermes/Odysseus…"*. That is superseded — the operator selected OpenClaw and **installing it is now the mission**, not a gated later step. Follow `apex-meta/openclaw/SETUP.md`. Authority: `OPENCLAW-LOCAL-LLM-MASTER-BRIEF.md` at the repo root.
...
Plan complete and saved to `apex-meta/local-orchestration-engine/project/plans/2026-08-10-fee-project-environment-implementation-plan.md`.
