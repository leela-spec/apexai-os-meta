```yaml
archive_metadata:
  original_path: .claude/skills/PrecapNextDay/templates/flow-prompt-pack-template.md
  archived_date: 2026-08-17
  reason: replaced_by_prompt-files-and-index-template.md_as_the_active_required_operator_output
  replacement: .claude/skills/PrecapNextDay/templates/prompt-files-and-index-template.md
...
`references/flow-prompt-pack-contract.md` (`flow_prompt_pack`), now demoted to optional
internal depth (Module 04 territory) in favor of real per-sprint prompt files plus an
index. Kept for history per D007.
