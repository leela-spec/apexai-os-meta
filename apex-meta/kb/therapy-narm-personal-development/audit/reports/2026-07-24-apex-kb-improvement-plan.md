...
**Revised priority order:** B1 → **A0 → A1 → A2 → A3 → P1** → B2 → B3 → AG1 → B4 → *A4 (optional)* → C1 → C2 → C3. Implementation steps from the approved plan are preserved, only reprioritized.
