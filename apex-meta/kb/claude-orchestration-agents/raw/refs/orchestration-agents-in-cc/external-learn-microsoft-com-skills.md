...
Published Time: Fri, 26 Jun 2026 20:49:38 GMT
...
For mixing multiple sources in one provider, use `AgentSkillsProviderBuilder` (C#) or compose source classes such as `AggregatingSkillsSource`, `FilteringSkillsSource`, and `DeduplicatingSkillsSource` (Python) - see [Builder: advanced multi-source scenarios](https://learn.microsoft.com/en-us/agent-framework/agents/skills#builder-advanced-multi-source-scenarios) (C#) or [Source composition: advanced multi-source scenarios](https://learn.microsoft.com/en-us/agent-framework/agents/skills#source-composition-advanced-multi-source-scenarios) (Python).
...
*   `volume_converter_skill` - any `InlineSkill` instance, built as shown in [Code-defined skills](https://learn.microsoft.com/en-us/agent-framework/agents/skills#code-defined-skills).
*   `TemperatureConverterSkill` - any `ClassSkill` subclass, built as shown in [Class-based skills](https://learn.microsoft.com/en-us/agent-framework/agents/skills#class-based-skills).
*   `my_runner` - a `SkillScriptRunner` callable, defined as shown in [Script execution](https://learn.microsoft.com/en-us/agent-framework/agents/skills#script-execution).
