...
Candidate-only capture surface for Meta Ops learning. This file is never runtime truth.

## Write permissions

- `meta_ops` may add candidate entries
...
- EMPTY_STATE: no pending Meta Ops learning entries.
