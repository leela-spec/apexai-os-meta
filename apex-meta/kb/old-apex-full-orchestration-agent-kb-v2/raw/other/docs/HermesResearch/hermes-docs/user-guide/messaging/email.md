...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#prerequisites "Direct link to Prerequisites")
...
### Gmail Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#gmail-setup "Direct link to Gmail Setup")
...
### Outlook / Microsoft 365[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#outlook--microsoft-365 "Direct link to Outlook / Microsoft 365")
...
### Other Providers[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#other-providers "Direct link to Other Providers")
...
## Step 1: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#step-1-configure-hermes "Direct link to Step 1: Configure Hermes")
...
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#manual-configuration "Direct link to Manual Configuration")
...
## Step 2: Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#step-2-start-the-gateway "Direct link to Step 2: Start the Gateway")
...
## How It Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#how-it-works "Direct link to How It Works")

### Receiving Messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#receiving-messages "Direct link to Receiving Messages")
...
### File Attachments[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#file-attachments "Direct link to File Attachments")
...
### Skipping Attachments[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#skipping-attachments "Direct link to Skipping Attachments")
...
## Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#access-control "Direct link to Access Control")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#troubleshooting "Direct link to Troubleshooting")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#security "Direct link to Security")
...
## Environment Variables Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/email#environment-variables-reference "Direct link to Environment Variables Reference")
