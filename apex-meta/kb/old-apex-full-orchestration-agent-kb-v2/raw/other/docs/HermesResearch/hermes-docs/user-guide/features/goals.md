...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/goals
...
## When to use it[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#when-to-use-it "Direct link to When to use it")
...
## Quick start[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#quick-start "Direct link to Quick start")
...
## Commands[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#commands "Direct link to Commands")
...
## Adding criteria mid-goal: `/subgoal`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#adding-criteria-mid-goal-subgoal "Direct link to adding-criteria-mid-goal-subgoal")
...
## Behavior details[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#behavior-details "Direct link to Behavior details")

### The judge[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#the-judge "Direct link to The judge")
...
### Fail-open semantics[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#fail-open-semantics "Direct link to Fail-open semantics")
...
### Turn budget[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#turn-budget "Direct link to Turn budget")
...
### User messages always preempt[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#user-messages-always-preempt "Direct link to User messages always preempt")
...
### Mid-run safety (gateway)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#mid-run-safety-gateway "Direct link to Mid-run safety (gateway)")
...
### Persistence[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#persistence "Direct link to Persistence")
...
### Prompt cache[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#prompt-cache "Direct link to Prompt cache")
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#configuration "Direct link to Configuration")
...
### Choosing the judge model[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#choosing-the-judge-model "Direct link to Choosing the judge model")

The judge uses the `goal_judge` auxiliary task. By default it resolves to your main model (see [Auxiliary Models](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#auxiliary-models)). If you want to route the judge to a cheap fast model to keep costs down, add an override:
...
## Example walkthrough[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#example-walkthrough "Direct link to Example walkthrough")
...
## When the judge gets it wrong[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#when-the-judge-gets-it-wrong "Direct link to When the judge gets it wrong")
...
## Attribution[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/goals#attribution "Direct link to Attribution")
