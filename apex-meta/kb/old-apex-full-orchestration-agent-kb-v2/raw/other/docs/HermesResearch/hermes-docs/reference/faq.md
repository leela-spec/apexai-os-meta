...
URL Source: https://hermes-agent.nousresearch.com/docs/reference/faq
...
## Frequently Asked Questions[​](https://hermes-agent.nousresearch.com/docs/reference/faq#frequently-asked-questions "Direct link to Frequently Asked Questions")

### What LLM providers work with Hermes?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#what-llm-providers-work-with-hermes "Direct link to What LLM providers work with Hermes?")
...
Set your provider with `hermes model` or by editing `~/.hermes/.env`. See the [Environment Variables](https://hermes-agent.nousresearch.com/docs/reference/environment-variables) reference for all provider keys.

### Does it work on Windows?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#does-it-work-on-windows "Direct link to Does it work on Windows?")
...
### I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#i-run-hermes-in-wsl2-whats-the-best-way-to-control-my-normal-windows-chrome "Direct link to I run Hermes in WSL2. What's the best way to control my normal Windows Chrome?")
...
*   [Browser Automation](https://hermes-agent.nousresearch.com/docs/user-guide/features/browser#wsl2--windows-chrome-prefer-mcp-over-browser-connect)

### Does it work on Android / Termux?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#does-it-work-on-android--termux "Direct link to Does it work on Android / Termux?")
...
For the fully explicit manual steps, supported extras, and current limitations, see the [Termux guide](https://hermes-agent.nousresearch.com/docs/getting-started/termux).
...
### Is my data sent anywhere?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#is-my-data-sent-anywhere "Direct link to Is my data sent anywhere?")
...
### Can I use it offline / with local models?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#can-i-use-it-offline--with-local-models "Direct link to Can I use it offline / with local models?")
...
This works with Ollama, vLLM, llama.cpp server, SGLang, LocalAI, and others. See the [Configuration guide](https://hermes-agent.nousresearch.com/docs/user-guide/configuration) for details.
...
### Can multiple people use one instance?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#can-multiple-people-use-one-instance "Direct link to Can multiple people use one instance?")

Yes. The [messaging gateway](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/) lets multiple users interact with the same Hermes Agent instance via Telegram, Discord, Slack, WhatsApp, or Home Assistant. Access is controlled through allowlists (specific user IDs) and DM pairing (first user to message claims access).

### What's the difference between memory and skills?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#whats-the-difference-between-memory-and-skills "Direct link to What's the difference between memory and skills?")
...
Both persist across sessions. See [Memory](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory) and [Skills](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills) for details.

### Can I use it in my own Python project?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#can-i-use-it-in-my-own-python-project "Direct link to Can I use it in my own Python project?")
...
See the [Python Library guide](https://hermes-agent.nousresearch.com/docs/user-guide/features/code-execution) for full API usage.

* * *

## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/reference/faq#troubleshooting "Direct link to Troubleshooting")

### Installation Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#installation-issues "Direct link to Installation Issues")

#### `hermes: command not found` after installation[​](https://hermes-agent.nousresearch.com/docs/reference/faq#hermes-command-not-found-after-installation "Direct link to hermes-command-not-found-after-installation")
...
#### Python version too old[​](https://hermes-agent.nousresearch.com/docs/reference/faq#python-version-too-old "Direct link to Python version too old")
...
#### Terminal commands say `node: command not found` (or `nvm`, `pyenv`, `asdf`, …)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf- "Direct link to terminal-commands-say-node-command-not-found-or-nvm-pyenv-asdf-")
...
#### `uv: command not found`[​](https://hermes-agent.nousresearch.com/docs/reference/faq#uv-command-not-found "Direct link to uv-command-not-found")
...
#### Permission denied errors during install[​](https://hermes-agent.nousresearch.com/docs/reference/faq#permission-denied-errors-during-install "Direct link to Permission denied errors during install")
...
### Provider & Model Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#provider--model-issues "Direct link to Provider & Model Issues")

#### `/model` only shows one provider / can't switch providers[​](https://hermes-agent.nousresearch.com/docs/reference/faq#model-only-shows-one-provider--cant-switch-providers "Direct link to model-only-shows-one-provider--cant-switch-providers")
...
#### API key not working[​](https://hermes-agent.nousresearch.com/docs/reference/faq#api-key-not-working "Direct link to API key not working")
...
#### Model not available / model not found[​](https://hermes-agent.nousresearch.com/docs/reference/faq#model-not-available--model-not-found "Direct link to Model not available / model not found")
...
#### Rate limiting (429 errors)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#rate-limiting-429-errors "Direct link to Rate limiting (429 errors)")
...
#### Context length exceeded[​](https://hermes-agent.nousresearch.com/docs/reference/faq#context-length-exceeded "Direct link to Context length exceeded")
...
See [Context Length Detection](https://hermes-agent.nousresearch.com/docs/integrations/providers#context-length-detection) for how auto-detection works and all override options.

* * *

### Terminal Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#terminal-issues "Direct link to Terminal Issues")

#### Command blocked as dangerous[​](https://hermes-agent.nousresearch.com/docs/reference/faq#command-blocked-as-dangerous "Direct link to Command blocked as dangerous")
...
*   See the full list of dangerous patterns in the [Security docs](https://hermes-agent.nousresearch.com/docs/user-guide/security)
...
#### `sudo` not working via messaging gateway[​](https://hermes-agent.nousresearch.com/docs/reference/faq#sudo-not-working-via-messaging-gateway "Direct link to sudo-not-working-via-messaging-gateway")
...
#### Docker backend not connecting[​](https://hermes-agent.nousresearch.com/docs/reference/faq#docker-backend-not-connecting "Direct link to Docker backend not connecting")
...
### Messaging Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#messaging-issues "Direct link to Messaging Issues")

#### Bot not responding to messages[​](https://hermes-agent.nousresearch.com/docs/reference/faq#bot-not-responding-to-messages "Direct link to Bot not responding to messages")
...
#### Messages not delivering[​](https://hermes-agent.nousresearch.com/docs/reference/faq#messages-not-delivering "Direct link to Messages not delivering")
...
#### Allowlist confusion — who can talk to the bot?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#allowlist-confusion--who-can-talk-to-the-bot "Direct link to Allowlist confusion — who can talk to the bot?")
...
Configure in `~/.hermes/config.yaml` under your gateway's settings. See the [Messaging docs](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/).

#### Gateway won't start[​](https://hermes-agent.nousresearch.com/docs/reference/faq#gateway-wont-start "Direct link to Gateway won't start")

**Cause:** Missing dependencies, port conflicts, or misconfigured tokens.

**Solution:**

`# Install core messaging gateway dependenciespip install "hermes-agent[messaging]"  # Telegram, Discord, Slack, and shared gateway deps# Check for port conflictslsof -i :8080# Verify configurationhermes config show`

#### WSL: Gateway keeps disconnecting or `hermes gateway start` fails[​](https://hermes-agent.nousresearch.com/docs/reference/faq#wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails "Direct link to wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails")
...
#### macOS: Node.js / ffmpeg / other tools not found by gateway[​](https://hermes-agent.nousresearch.com/docs/reference/faq#macos-nodejs--ffmpeg--other-tools-not-found-by-gateway "Direct link to macOS: Node.js / ffmpeg / other tools not found by gateway")
...
### Performance Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#performance-issues "Direct link to Performance Issues")

#### Slow responses[​](https://hermes-agent.nousresearch.com/docs/reference/faq#slow-responses "Direct link to Slow responses")
...
#### High token usage[​](https://hermes-agent.nousresearch.com/docs/reference/faq#high-token-usage "Direct link to High token usage")
...
#### Session getting too long[​](https://hermes-agent.nousresearch.com/docs/reference/faq#session-getting-too-long "Direct link to Session getting too long")
...
### MCP Issues[​](https://hermes-agent.nousresearch.com/docs/reference/faq#mcp-issues "Direct link to MCP Issues")

#### MCP server not connecting[​](https://hermes-agent.nousresearch.com/docs/reference/faq#mcp-server-not-connecting "Direct link to MCP server not connecting")
...
#### Tools not showing up from MCP server[​](https://hermes-agent.nousresearch.com/docs/reference/faq#tools-not-showing-up-from-mcp-server "Direct link to Tools not showing up from MCP server")
...
#### MCP timeout errors[​](https://hermes-agent.nousresearch.com/docs/reference/faq#mcp-timeout-errors "Direct link to MCP timeout errors")
...
## Profiles[​](https://hermes-agent.nousresearch.com/docs/reference/faq#profiles "Direct link to Profiles")

### How do profiles differ from just setting HERMES_HOME?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#how-do-profiles-differ-from-just-setting-hermes_home "Direct link to How do profiles differ from just setting HERMES_HOME?")
...
### What happens when I run `hermes update`?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#what-happens-when-i-run-hermes-update "Direct link to what-happens-when-i-run-hermes-update")
...
### How many profiles can I run?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#how-many-profiles-can-i-run "Direct link to How many profiles can I run?")
...
## Workflows & Patterns[​](https://hermes-agent.nousresearch.com/docs/reference/faq#workflows--patterns "Direct link to Workflows & Patterns")

### Using different models for different tasks (multi-model workflows)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#using-different-models-for-different-tasks-multi-model-workflows "Direct link to Using different models for different tasks (multi-model workflows)")
...
See [Subagent Delegation](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation) for more on how delegation works.

### Running multiple agents on one WhatsApp number (per-chat binding)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#running-multiple-agents-on-one-whatsapp-number-per-chat-binding "Direct link to Running multiple agents on one WhatsApp number (per-chat binding)")
...
See [Profiles](https://hermes-agent.nousresearch.com/docs/user-guide/profiles) and [WhatsApp setup](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp) for more details.

### Controlling what shows up in Telegram (hiding logs and reasoning)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#controlling-what-shows-up-in-telegram-hiding-logs-and-reasoning "Direct link to Controlling what shows up in Telegram (hiding logs and reasoning)")
...
### Managing skills on Telegram (slash command limit)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#managing-skills-on-telegram-slash-command-limit "Direct link to Managing skills on Telegram (slash command limit)")
...
### Shared thread sessions (multiple users, one conversation)[​](https://hermes-agent.nousresearch.com/docs/reference/faq#shared-thread-sessions-multiple-users-one-conversation "Direct link to Shared thread sessions (multiple users, one conversation)")
...
### Exporting Hermes to another machine[​](https://hermes-agent.nousresearch.com/docs/reference/faq#exporting-hermes-to-another-machine "Direct link to Exporting Hermes to another machine")
...
### Moving a single profile to another machine[​](https://hermes-agent.nousresearch.com/docs/reference/faq#moving-a-single-profile-to-another-machine "Direct link to Moving a single profile to another machine")
...
### `hermes backup` vs `hermes profile export`[​](https://hermes-agent.nousresearch.com/docs/reference/faq#hermes-backup-vs-hermes-profile-export "Direct link to hermes-backup-vs-hermes-profile-export")
...
### Permission denied when reloading shell after install[​](https://hermes-agent.nousresearch.com/docs/reference/faq#permission-denied-when-reloading-shell-after-install "Direct link to Permission denied when reloading shell after install")
...
### Error 400 on first agent run[​](https://hermes-agent.nousresearch.com/docs/reference/faq#error-400-on-first-agent-run "Direct link to Error 400 on first agent run")
...
## Still Stuck?[​](https://hermes-agent.nousresearch.com/docs/reference/faq#still-stuck "Direct link to Still Stuck?")
