...
URL Source: https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns
...
## When to Delegate[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#when-to-delegate "Direct link to When to Delegate")
...
## Pattern: Parallel Research[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-parallel-research "Direct link to Pattern: Parallel Research")
...
## Pattern: Code Review[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-code-review "Direct link to Pattern: Code Review")
...
## Pattern: Compare Alternatives[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-compare-alternatives "Direct link to Pattern: Compare Alternatives")
...
## Pattern: Multi-File Refactoring[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-multi-file-refactoring "Direct link to Pattern: Multi-File Refactoring")
...
## Pattern: Gather Then Analyze[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#pattern-gather-then-analyze "Direct link to Pattern: Gather Then Analyze")
...
## Toolset Selection[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#toolset-selection "Direct link to Toolset Selection")
...
## Constraints[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#constraints "Direct link to Constraints")
...
### Tuning Concurrency and Depth[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#tuning-concurrency-and-depth "Direct link to Tuning Concurrency and Depth")
...
## Tips[​](https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns#tips "Direct link to Tips")
...
_For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see [Subagent Delegation](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation)._
