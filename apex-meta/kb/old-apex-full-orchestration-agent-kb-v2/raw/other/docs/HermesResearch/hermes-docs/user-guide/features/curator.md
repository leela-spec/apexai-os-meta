...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/curator
...
`curator:  enabled: true  interval_hours: 168          # 7 days  min_idle_hours: 2  stale_after_days: 30  archive_after_days: 90`
...
### Rename map in the summary[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/curator#rename-map-in-the-summary "Direct link to Rename map in the summary")
