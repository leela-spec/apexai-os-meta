...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#prerequisites "Direct link to Prerequisites")
...
### Installing signal-cli[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#installing-signal-cli "Direct link to Installing signal-cli")
...
## Step 1: Link Your Signal Account[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-1-link-your-signal-account "Direct link to Step 1: Link Your Signal Account")
...
## Step 2: Start the signal-cli Daemon[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-2-start-the-signal-cli-daemon "Direct link to Step 2: Start the signal-cli Daemon")
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#step-3-configure-hermes "Direct link to Step 3: Configure Hermes")
...
### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#manual-configuration "Direct link to Manual Configuration")
...
## Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#access-control "Direct link to Access Control")

### DM Access[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#dm-access "Direct link to DM Access")
...
### Group Access[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#group-access "Direct link to Group Access")
...
## Features[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#features "Direct link to Features")

### Attachments[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#attachments "Direct link to Attachments")
...
### Native Formatting, Reply Quotes, and Reactions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#native-formatting-reply-quotes-and-reactions "Direct link to Native Formatting, Reply Quotes, and Reactions")
...
### Typing Indicators[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#typing-indicators "Direct link to Typing Indicators")

The bot sends typing indicators while processing messages, refreshing every 8 seconds.

### Phone Number Redaction[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#phone-number-redaction "Direct link to Phone Number Redaction")
...
### Note to Self (Single-Number Setup)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#note-to-self-single-number-setup "Direct link to Note to Self (Single-Number Setup)")
...
### Health Monitoring[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#health-monitoring "Direct link to Health Monitoring")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#troubleshooting "Direct link to Troubleshooting")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#security "Direct link to Security")
...
## Environment Variables Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/signal#environment-variables-reference "Direct link to Environment Variables Reference")
