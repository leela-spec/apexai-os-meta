...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks
...
## Video Tutorial[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#video-tutorial "Direct link to Video Tutorial")

[Video 3](https://www.youtube.com/watch?v=WNYe5mD4fY8)

* * *

## Quick Start[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#quick-start "Direct link to Quick Start")
...
## Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#setup "Direct link to Setup")

There are two ways to enable the webhook adapter.

### Via setup wizard[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#via-setup-wizard "Direct link to Via setup wizard")

`hermes gateway setup`

Follow the prompts to enable webhooks, set the port, and set a global HMAC secret.

### Via environment variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#via-environment-variables "Direct link to Via environment variables")

Add to `~/.hermes/.env`:

`WEBHOOK_ENABLED=trueWEBHOOK_PORT=8644        # defaultWEBHOOK_SECRET=your-global-secret`

### Verify the server[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#verify-the-server "Direct link to Verify the server")
...
## Configuring Routes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#configuring-routes "Direct link to Configuring Routes")
...
### Route properties[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#route-properties "Direct link to Route properties")
...
| `deliver_only` | No | If `true`, skip the agent entirely — the rendered `prompt` template becomes the literal message that gets delivered. Zero LLM cost, sub-second delivery. See [Direct Delivery Mode](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#direct-delivery-mode) for use cases. Requires `deliver` to be a real target (not `log`). |

### Full example[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#full-example "Direct link to Full example")
...
### Prompt Templates[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#prompt-templates "Direct link to Prompt Templates")
...
### Forum Topic Delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#forum-topic-delivery "Direct link to Forum Topic Delivery")
...
## GitHub PR Review (Step by Step)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#github-pr-review "Direct link to GitHub PR Review (Step by Step)")

This walkthrough sets up automatic code review on every pull request.

### 1. Create the webhook in GitHub[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#1-create-the-webhook-in-github "Direct link to 1. Create the webhook in GitHub")
...
### 2. Add the route config[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#2-add-the-route-config "Direct link to 2. Add the route config")

Add the `github-pr` route to your `~/.hermes/config.yaml` as shown in the example above.

### 3. Ensure `gh` CLI is authenticated[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#3-ensure-gh-cli-is-authenticated "Direct link to 3-ensure-gh-cli-is-authenticated")

The `github_comment` delivery type uses the GitHub CLI to post comments:

`gh auth login`

### 4. Test it[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#4-test-it "Direct link to 4. Test it")

Open a pull request on the repository. The webhook fires, Hermes processes the event, and posts a review comment on the PR.

* * *

## GitLab Webhook Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#gitlab-webhook-setup "Direct link to GitLab Webhook Setup")
...
### 1. Create the webhook in GitLab[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#1-create-the-webhook-in-gitlab "Direct link to 1. Create the webhook in GitLab")
...
### 2. Add the route config[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#2-add-the-route-config-1 "Direct link to 2. Add the route config")
...
## Delivery Options[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#delivery-options "Direct link to Delivery Options")
...
## Direct Delivery Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#direct-delivery-mode "Direct link to Direct Delivery Mode")
...
### When to use direct delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#when-to-use-direct-delivery "Direct link to When to use direct delivery")
...
### Example: Telegram push from Supabase[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#example-telegram-push-from-supabase "Direct link to Example: Telegram push from Supabase")
...
### Example: Dynamic subscription via CLI[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#example-dynamic-subscription-via-cli "Direct link to Example: Dynamic subscription via CLI")
...
### Response codes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#response-codes "Direct link to Response codes")
...
### Configuration gotchas[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#configuration-gotchas "Direct link to Configuration gotchas")
...
## Dynamic Subscriptions (CLI)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#dynamic-subscriptions "Direct link to Dynamic Subscriptions (CLI)")
...
### Create a subscription[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#create-a-subscription "Direct link to Create a subscription")
...
### List subscriptions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#list-subscriptions "Direct link to List subscriptions")

`hermes webhook list`

### Remove a subscription[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#remove-a-subscription "Direct link to Remove a subscription")

`hermes webhook remove github-issues`

### Test a subscription[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#test-a-subscription "Direct link to Test a subscription")

`hermes webhook test github-issueshermes webhook test github-issues --payload '{"issue": {"number": 42, "title": "Test"}}'`

### How dynamic subscriptions work[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#how-dynamic-subscriptions-work "Direct link to How dynamic subscriptions work")
...
### Agent-driven subscriptions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#agent-driven-subscriptions "Direct link to Agent-driven subscriptions")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#security "Direct link to Security")

The webhook adapter includes multiple layers of security:

### HMAC signature validation[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#hmac-signature-validation "Direct link to HMAC signature validation")
...
### Secret is required[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#secret-is-required "Direct link to Secret is required")
...
### Rate limiting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#rate-limiting "Direct link to Rate limiting")
...
### Idempotency[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#idempotency "Direct link to Idempotency")
...
### Body size limits[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#body-size-limits "Direct link to Body size limits")
...
### Prompt injection risk[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#prompt-injection-risk "Direct link to Prompt injection risk")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#troubleshooting "Direct link to Troubleshooting")

### Webhook not arriving[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#webhook-not-arriving "Direct link to Webhook not arriving")
...
### Signature validation failing[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#signature-validation-failing "Direct link to Signature validation failing")
...
### Event being ignored[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#event-being-ignored "Direct link to Event being ignored")
...
### Agent not responding[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#agent-not-responding "Direct link to Agent not responding")
...
### Duplicate responses[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#duplicate-responses "Direct link to Duplicate responses")
...
## Environment Variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/webhooks#environment-variables "Direct link to Environment Variables")
