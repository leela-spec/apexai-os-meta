...
URL Source: https://hermes-agent.nousresearch.com/docs/reference/tools-reference
...
In addition to built-in tools, Hermes can load tools dynamically from MCP servers. MCP tools appear with the prefix `mcp_<server>_` (e.g., `mcp_github_create_issue` for the `github` MCP server). See [MCP Integration](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp) for configuration.
...
## `messaging` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#messaging-toolset "Direct link to messaging-toolset")
...
## `moa` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#moa-toolset "Direct link to moa-toolset")
