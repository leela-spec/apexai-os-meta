...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#how-hermes-behaves "Direct link to How Hermes Behaves")
...
### Session Model in Mattermost[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#session-model-in-mattermost "Direct link to Session Model in Mattermost")
...
## Step 1: Enable Bot Accounts[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-1-enable-bot-accounts "Direct link to Step 1: Enable Bot Accounts")
...
## Step 2: Create a Bot Account[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-2-create-a-bot-account "Direct link to Step 2: Create a Bot Account")
...
## Step 3: Add the Bot to Channels[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-3-add-the-bot-to-channels "Direct link to Step 3: Add the Bot to Channels")
...
## Step 4: Find Your Mattermost User ID[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-4-find-your-mattermost-user-id "Direct link to Step 4: Find Your Mattermost User ID")
...
## Step 5: Configure Hermes Agent[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#step-5-configure-hermes-agent "Direct link to Step 5: Configure Hermes Agent")

### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#option-a-interactive-setup-recommended "Direct link to Option A: Interactive Setup (Recommended)")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#option-b-manual-configuration "Direct link to Option B: Manual Configuration")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#start-the-gateway "Direct link to Start the Gateway")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#home-channel "Direct link to Home Channel")
...
### Using the Slash Command[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#using-the-slash-command "Direct link to Using the Slash Command")

Type `/sethome` in any Mattermost channel where the bot is present. That channel becomes the home channel.

### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#manual-configuration "Direct link to Manual Configuration")
...
## Reply Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#reply-mode "Direct link to Reply Mode")
...
## Mention Behavior[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#mention-behavior "Direct link to Mention Behavior")
...
## Channel allowlist (`allowed_channels`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#channel-allowlist-allowed_channels "Direct link to channel-allowlist-allowed_channels")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#troubleshooting "Direct link to Troubleshooting")

### Bot is not responding to messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#bot-is-not-responding-to-messages "Direct link to Bot is not responding to messages")
...
### 403 Forbidden errors[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#403-forbidden-errors "Direct link to 403 Forbidden errors")
...
### WebSocket disconnects / reconnection loops[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#websocket-disconnects--reconnection-loops "Direct link to WebSocket disconnects / reconnection loops")
...
### "Failed to authenticate" on startup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#failed-to-authenticate-on-startup "Direct link to \"Failed to authenticate\" on startup")
...
### Bot is offline[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#bot-is-offline "Direct link to Bot is offline")
...
### "User not allowed" / Bot ignores you[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#user-not-allowed--bot-ignores-you "Direct link to \"User not allowed\" / Bot ignores you")
...
## Per-Channel Prompts[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#per-channel-prompts "Direct link to Per-Channel Prompts")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#security "Direct link to Security")
...
## Notes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/mattermost#notes "Direct link to Notes")
