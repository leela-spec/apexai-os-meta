...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#prerequisites "Direct link to Prerequisites")
...
## Overview[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#overview "Direct link to Overview")
...
## Requirements[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#requirements "Direct link to Requirements")

### Python Packages[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#python-packages "Direct link to Python Packages")

`# CLI voice mode (microphone + audio playback)pip install "hermes-agent[voice]"# Discord + Telegram messaging (includes discord.py[voice] for VC support)pip install "hermes-agent[messaging]"# Premium TTS (ElevenLabs)pip install "hermes-agent[tts-premium]"# Local TTS (NeuTTS, optional)python -m pip install -U neutts[all]# Everything at oncepip install "hermes-agent[all]"`
...
### System Dependencies[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#system-dependencies "Direct link to System Dependencies")
...
### API Keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#api-keys "Direct link to API Keys")
...
## CLI Voice Mode[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#cli-voice-mode "Direct link to CLI Voice Mode")
...
### Quick Start[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#quick-start "Direct link to Quick Start")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#how-it-works "Direct link to How It Works")
...
### Silence Detection[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#silence-detection "Direct link to Silence Detection")
...
### Streaming TTS[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#streaming-tts "Direct link to Streaming TTS")
...
### Hallucination Filter[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#hallucination-filter "Direct link to Hallucination Filter")
...
## Gateway Voice Reply (Telegram & Discord)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#gateway-voice-reply-telegram--discord "Direct link to Gateway Voice Reply (Telegram & Discord)")
...
### Discord: Channels vs DMs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#discord-channels-vs-dms "Direct link to Discord: Channels vs DMs")
...
### Commands[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#commands "Direct link to Commands")
...
### Modes[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#modes "Direct link to Modes")
...
### Platform Delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#platform-delivery "Direct link to Platform Delivery")
...
## Discord Voice Channels[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#discord-voice-channels "Direct link to Discord Voice Channels")
...
### Setup[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#setup "Direct link to Setup")

#### 1. Discord Bot Permissions[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#1-discord-bot-permissions "Direct link to 1. Discord Bot Permissions")
...
#### 2. Privileged Gateway Intents[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#2-privileged-gateway-intents "Direct link to 2. Privileged Gateway Intents")
...
#### 3. Opus Codec[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#3-opus-codec "Direct link to 3. Opus Codec")
...
#### 4. Environment Variables[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#4-environment-variables "Direct link to 4. Environment Variables")
...
### Start the Gateway[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#start-the-gateway "Direct link to Start the Gateway")

`hermes gateway        # Start with existing configuration`

The bot should come online in Discord within a few seconds.

### Commands[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#commands-1 "Direct link to Commands")
...
### How It Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#how-it-works-1 "Direct link to How It Works")
...
### Text Channel Integration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#text-channel-integration "Direct link to Text Channel Integration")
...
### Echo Prevention[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#echo-prevention "Direct link to Echo Prevention")
...
### Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#access-control "Direct link to Access Control")
...
### STT Provider Comparison[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#stt-provider-comparison "Direct link to STT Provider Comparison")
...
### TTS Provider Comparison[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#tts-provider-comparison "Direct link to TTS Provider Comparison")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#troubleshooting "Direct link to Troubleshooting")

### "No audio device found" (CLI)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#no-audio-device-found-cli "Direct link to \"No audio device found\" (CLI)")

PortAudio is not installed:

`brew install portaudio    # macOSsudo apt install portaudio19-dev  # Ubuntu`

If you are running Hermes inside Docker on a Linux desktop, the container also needs access to your host audio socket. See the [Docker audio bridge](https://hermes-agent.nousresearch.com/docs/user-guide/docker#optional-linux-desktop-audio-bridge) notes for a PulseAudio/PipeWire-compatible setup.

### Bot doesn't respond in Discord server channels[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-doesnt-respond-in-discord-server-channels "Direct link to Bot doesn't respond in Discord server channels")
...
### Bot joins VC but doesn't hear me[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-joins-vc-but-doesnt-hear-me "Direct link to Bot joins VC but doesn't hear me")
...
### Bot hears me but doesn't respond[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-hears-me-but-doesnt-respond "Direct link to Bot hears me but doesn't respond")
...
### Bot responds in text but not in voice channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#bot-responds-in-text-but-not-in-voice-channel "Direct link to Bot responds in text but not in voice channel")

*   TTS provider may be failing — check API key and quota
*   Edge TTS (free, no key) is the default fallback
*   Check logs for TTS errors

### Whisper returns garbage text[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/voice-mode#whisper-returns-garbage-text "Direct link to Whisper returns garbage text")
