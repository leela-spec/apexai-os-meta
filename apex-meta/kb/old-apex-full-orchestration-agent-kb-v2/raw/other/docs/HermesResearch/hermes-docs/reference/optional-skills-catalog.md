...
URL Source: https://hermes-agent.nousresearch.com/docs/reference/optional-skills-catalog
...
| [**shop-app**](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/productivity/productivity-shop-app) | Shop.app: product search, order tracking, returns, reorder. |
