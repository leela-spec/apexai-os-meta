...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp
...
## Two Modes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#two-modes "Direct link to Two Modes")
...
## Prerequisites[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#prerequisites "Direct link to Prerequisites")
...
## Step 1: Run the Setup Wizard[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-1-run-the-setup-wizard "Direct link to Step 1: Run the Setup Wizard")
...
## Step 2: Getting a Second Phone Number (Bot Mode)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-2-getting-a-second-phone-number-bot-mode "Direct link to Step 2: Getting a Second Phone Number (Bot Mode)")
...
## Step 3: Configure Hermes[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#step-3-configure-hermes "Direct link to Step 3: Configure Hermes")
...
Setting `WHATSAPP_ALLOWED_USERS=*` allows **all** senders (equivalent to `WHATSAPP_ALLOW_ALL_USERS=true`). This is consistent with [Signal group allowlists](https://hermes-agent.nousresearch.com/docs/reference/environment-variables). To use the pairing flow instead, remove both variables and rely on the [DM pairing system](https://hermes-agent.nousresearch.com/docs/user-guide/security#dm-pairing-system).
...
## Session Persistence[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#session-persistence "Direct link to Session Persistence")
...
## Re-pairing[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#re-pairing "Direct link to Re-pairing")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#voice-messages "Direct link to Voice Messages")
...
## Message Formatting & Delivery[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#message-formatting--delivery "Direct link to Message Formatting & Delivery")
...
### Chunking[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#chunking "Direct link to Chunking")
...
### WhatsApp-Compatible Markdown[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#whatsapp-compatible-markdown "Direct link to WhatsApp-Compatible Markdown")
...
### Tool Progress[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#tool-progress "Direct link to Tool Progress")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#troubleshooting "Direct link to Troubleshooting")
...
| **macOS: "Node.js not installed" but node works in terminal** | launchd services don't inherit your shell PATH. Run `hermes gateway install` to re-snapshot your current PATH into the plist, then `hermes gateway start`. See the [Gateway Service docs](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/#macos-launchd) for details. |
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/whatsapp#security "Direct link to Security")
