...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation
...
## Toolset Selection Tips[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#toolset-selection-tips "Direct link to Toolset Selection Tips")
...
*   `delegation` — blocked for leaf subagents (the default). Retained for `role="orchestrator"` children, bounded by `max_spawn_depth` — see [Depth Limit and Nested Orchestration](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#depth-limit-and-nested-orchestration) below.
