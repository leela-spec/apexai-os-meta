...
URL Source: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord
...
## How Hermes Behaves[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#how-hermes-behaves "Direct link to How Hermes Behaves")
...
### Discord Gateway Model[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discord-gateway-model "Direct link to Discord Gateway Model")
...
### Session Model in Discord[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#session-model-in-discord "Direct link to Session Model in Discord")
...
### Interrupts and Concurrency[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#interrupts-and-concurrency "Direct link to Interrupts and Concurrency")
...
## Step 1: Create a Discord Application[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-1-create-a-discord-application "Direct link to Step 1: Create a Discord Application")
...
## Step 2: Create the Bot[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-2-create-the-bot "Direct link to Step 2: Create the Bot")
...
## Step 3: Enable Privileged Gateway Intents[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-3-enable-privileged-gateway-intents "Direct link to Step 3: Enable Privileged Gateway Intents")
...
## Step 4: Get the Bot Token[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-4-get-the-bot-token "Direct link to Step 4: Get the Bot Token")
...
## Step 5: Generate the Invite URL[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-5-generate-the-invite-url "Direct link to Step 5: Generate the Invite URL")

You need an OAuth2 URL to invite the bot to your server. There are two ways to do this:

### Option A: Using the Installation Tab (Recommended)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-a-using-the-installation-tab-recommended "Direct link to Option A: Using the Installation Tab (Recommended)")
...
### Option B: Manual URL[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-b-manual-url "Direct link to Option B: Manual URL")
...
### Required Permissions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#required-permissions "Direct link to Required Permissions")
...
### Recommended Additional Permissions[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#recommended-additional-permissions "Direct link to Recommended Additional Permissions")

*   **Send Messages in Threads** — respond in thread conversations
*   **Add Reactions** — react to messages for acknowledgment

### Permission Integers[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#permission-integers "Direct link to Permission Integers")
...
## Step 6: Invite to Your Server[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-6-invite-to-your-server "Direct link to Step 6: Invite to Your Server")
...
## Step 7: Find Your Discord User ID[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-7-find-your-discord-user-id "Direct link to Step 7: Find Your Discord User ID")
...
## Step 8: Configure Hermes Agent[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#step-8-configure-hermes-agent "Direct link to Step 8: Configure Hermes Agent")

### Option A: Interactive Setup (Recommended)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-a-interactive-setup-recommended "Direct link to Option A: Interactive Setup (Recommended)")
...
### Option B: Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#option-b-manual-configuration "Direct link to Option B: Manual Configuration")
...
## Configuration Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#configuration-reference "Direct link to Configuration Reference")
...
### Environment Variables (`.env`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#environment-variables-env "Direct link to environment-variables-env")
...
| `DISCORD_ALLOW_MENTION_EVERYONE` | No | `false` | When `false` (default), the bot cannot ping `@everyone` or `@here` even if its response contains those tokens. Set to `true` to opt back in. See [Mention Control](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#mention-control) below. |
...
### Config File (`config.yaml`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#config-file-configyaml "Direct link to config-file-configyaml")
...
#### `discord.require_mention`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordrequire_mention "Direct link to discordrequire_mention")
...
#### `discord.thread_require_mention`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordthread_require_mention "Direct link to discordthread_require_mention")
...
#### `discord.free_response_channels`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordfree_response_channels "Direct link to discordfree_response_channels")
...
#### `discord.auto_thread`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordauto_thread "Direct link to discordauto_thread")

**Type:** boolean — **Default:**`true`

When enabled, every `@mention` in a regular text channel automatically creates a new thread for the conversation. This keeps the main channel clean and gives each conversation its own isolated session history. Once a thread is created, subsequent messages in that thread don't require `@mention` — the bot knows it's already participating. Set [`thread_require_mention`](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordthread_require_mention) to `true` to disable this in-thread shortcut for multi-bot setups.
...
#### `discord.reactions`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordreactions "Direct link to discordreactions")
...
#### `discord.ignored_channels`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordignored_channels "Direct link to discordignored_channels")
...
#### `discord.no_thread_channels`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordno_thread_channels "Direct link to discordno_thread_channels")
...
#### `discord.channel_prompts`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordchannel_prompts "Direct link to discordchannel_prompts")
...
#### `discord.history_backfill`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordhistory_backfill "Direct link to discordhistory_backfill")
...
#### `discord.history_backfill_limit`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#discordhistory_backfill_limit "Direct link to discordhistory_backfill_limit")
...
#### `group_sessions_per_user`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#group_sessions_per_user "Direct link to group_sessions_per_user")
...
See the [Session Model](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#session-model-in-discord) section above for the full implications of each mode.

#### `display.tool_progress`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#displaytool_progress "Direct link to displaytool_progress")
...
#### `display.tool_progress_command`[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#displaytool_progress_command "Direct link to displaytool_progress_command")
...
## Slash Command Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#slash-command-access-control "Direct link to Slash Command Access Control")
...
## Interactive Model Picker[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#interactive-model-picker "Direct link to Interactive Model Picker")
...
## Native Slash Commands for Skills[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#native-slash-commands-for-skills "Direct link to Native Slash Commands for Skills")
...
### Disabling Slash Command Registration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#disabling-slash-command-registration "Direct link to Disabling Slash Command Registration")
...
## Receiving Arbitrary File Types[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#receiving-arbitrary-file-types "Direct link to Receiving Arbitrary File Types")
...
`discord:  allow_any_attachment: true  # Optional — raise/disable the per-file size cap. Default is 32 MiB.  # The whole file is held in memory while being cached, so unlimited  # uploads carry a real memory cost.  max_attachment_bytes: 33554432   # bytes; 0 = unlimited`
...
## Interactive Prompts (clarify)[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#interactive-prompts-clarify "Direct link to Interactive Prompts (clarify)")
...
## Home Channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#home-channel "Direct link to Home Channel")
...
### Using the Slash Command[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#using-the-slash-command "Direct link to Using the Slash Command")

Type `/sethome` in any Discord channel where the bot is present. That channel becomes the home channel.

### Manual Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#manual-configuration "Direct link to Manual Configuration")
...
## Voice Messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#voice-messages "Direct link to Voice Messages")
...
## Forum Channels[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#forum-channels "Direct link to Forum Channels")
...
## Troubleshooting[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#troubleshooting "Direct link to Troubleshooting")

### Bot is online but not responding to messages[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-is-online-but-not-responding-to-messages "Direct link to Bot is online but not responding to messages")
...
### "Disallowed Intents" error on startup[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#disallowed-intents-error-on-startup "Direct link to \"Disallowed Intents\" error on startup")
...
### Bot can't see messages in a specific channel[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-cant-see-messages-in-a-specific-channel "Direct link to Bot can't see messages in a specific channel")
...
### 403 Forbidden errors[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#403-forbidden-errors "Direct link to 403 Forbidden errors")
...
### Bot is offline[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#bot-is-offline "Direct link to Bot is offline")
...
### "User not allowed" / Bot ignores you[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#user-not-allowed--bot-ignores-you "Direct link to \"User not allowed\" / Bot ignores you")
...
### People in the same channel are sharing context unexpectedly[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#people-in-the-same-channel-are-sharing-context-unexpectedly "Direct link to People in the same channel are sharing context unexpectedly")
...
## Security[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#security "Direct link to Security")
...
### Role-Based Access Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#role-based-access-control "Direct link to Role-Based Access Control")
...
### Mention Control[​](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/discord#mention-control "Direct link to Mention Control")
