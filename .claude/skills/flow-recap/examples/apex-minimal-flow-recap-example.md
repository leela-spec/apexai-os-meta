...
synthetic_normalized_raw_flow_dump:
  ...
  operator_summary:
    ...
    uncertainty_notes:
      - skipped-flow-marker-contract.md was missing during source inspection.
  produced_outputs:
  ...
  blockers_or_failures:
    - blocker_summary: skipped-flow-marker-contract.md is missing and must remain an optional source gap.
      status: open
  open_questions:
    - Should skipped-flow-marker-contract.md be created later by raw-flow-dump-normalize?
  model_usage_notes:
    - surface: ChatGPT
...
- `.claude/skills/raw-flow-dump-normalize/references/skipped-flow-marker-contract.md` was not found.
...
- Missing skipped-flow marker contract means skipped-flow references remain optional in this package.

**Unresolved questions:**

- Should `raw-flow-dump-normalize` own and later create `skipped-flow-marker-contract.md`?
...
- Missing skipped-flow marker contract remains a source gap.
