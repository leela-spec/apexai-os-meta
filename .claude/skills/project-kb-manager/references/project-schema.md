...
schemas:
  base_record:
    required:
      ...
      domain_type:
        type: enum
        allowed: [dev, content, business, comms, investment]
      project_status:
        type: enum
        allowed: [intake, scoping, active, blocked, review, done, archived]
      ...
      project_status_summary_for_precap:
        type: string
        constraint: one_sentence_feeds_current_project_status_overview
    optional:
      blocked_by:
        type: string
  ...
  milestone:
    required:
      ...
      status:
        type: enum
        allowed: [pending, active, done, blocked, skipped]
      priority_weight:
        type: integer
        min: 1
        max: 100
  ...
  progress_log_entry:
    ...
    required:
      ...
      source:
        type: enum
        allowed: [flow_recap, operator_note, manual]
    optional:
      date:
        type: string
        format: YYYY-MM-DD
